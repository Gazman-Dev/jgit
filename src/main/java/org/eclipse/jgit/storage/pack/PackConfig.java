...
public class PackConfig {
     ...
     *
     * @param db the repository to read settings from. The repository is not
     ...
     * {@link Config}.
     *
     * @param cfg the source to read settings from. The source is not retained
     ...
     *
     * @param cfg the source configuration to copy from.
     */
     ...
     * Default setting: {@value #DEFAULT_REUSE_DELTAS}
     *
     * @param reuseDeltas boolean indicating whether or not try to reuse deltas.
     */
     ...
     * Default setting: {@value #DEFAULT_REUSE_OBJECTS}
     *
     * @param reuseObjects boolean indicating whether or not writer should reuse existing
     ...
     * Default setting: {@value #DEFAULT_PRESERVE_OLD_PACKS}
     *
     * @param preserveOldPacks boolean indicating whether or not preserve old pack files
     * @since 4.7
     */
     ...
     * Default setting: {@value #DEFAULT_PRESERVE_OLD_PACKS}
     *
     * @param prunePreserved boolean indicating whether or not preserve old pack files
     * @since 4.7
     */
     ...
     * Default setting: {@value #DEFAULT_DELTA_COMPRESS}
     *
     * @param deltaCompress true to create deltas when {@link #isReuseDeltas()} is false,
     ...
     * Default setting: {@value #DEFAULT_MAX_DELTA_DEPTH}
     *
     * @param maxDeltaDepth maximum delta chain depth.
     */
     ...
     *
     * @param cut true to cut existing chains.
     * @since 3.0
     */
     ...
     *
     * @param single true to pack a single GC pack rather than GC and GC_REST packs
     * @since 4.9
     */
     ...
     * Default setting: {@value #DEFAULT_DELTA_SEARCH_WINDOW_SIZE}
     *
     * @param objectCount number of objects to search at once. Must be at least 2.
     */
     ...
     *
     * @param memoryLimit Maximum number of bytes to load at once, 0 for unlimited.
     */
     ...
     * Default setting: {@value #DEFAULT_DELTA_CACHE_SIZE}
     *
     * @param size number of bytes to cache. Set to 0 to enable an infinite
     ...
     * Default setting: {@value #DEFAULT_DELTA_CACHE_LIMIT}
     *
     * @param size maximum size (in bytes) of a delta to be cached.
     */
     ...
     *
     * @param packSize size of the pack file
     * @return whether we wait before opening a newly written pack to prevent
     * its lastModified timestamp could be racy
     * @since 5.1.8
     */
     ...
     * lastModified timestamp could be racy
     *
     * @param waitPreventRacyPack whether we wait before opening a newly written pack to prevent
     *                            its lastModified timestamp could be racy
     * @since 5.1.8
     */
     ...
     * {@code isWaitToPreventRacyPack} is {@code true}.
     *
     * @param minSizePreventRacyPack minimum packfile size, default is 100 MiB
     * @since 5.1.8
     */
     ...
     * Default setting: {@value Deflater#DEFAULT_COMPRESSION}
     *
     * @param level compression level, must be a valid level recognized by the
     *              {@link Deflater} class.
     */
     ...
     * Default setting: 0 (auto-detect processors)
     *
     * @param threads number of threads to use. If &lt;= 0 the number of available
     ...
     * delta search.
     *
     * @param executor executor to use for threads. Set to null to create a temporary
     ...
     * Default setting: {@value #DEFAULT_INDEX_VERSION}
     *
     * @param version the version to write. The special version 0 designates the
     ...
     * Default setting: {@value #DEFAULT_WRITE_REVERSE_INDEX}
     *
     * @param writeReverseIndex whether the writer should write reverse index files
     * @since 6.6
     */
     ...
     * Default setting: {@value #DEFAULT_BUILD_BITMAPS}
     *
     * @param buildBitmaps boolean indicating whether bitmaps may be included in the
     *                     index.
     * @since 3.0
     */
     ...
     *
     * @param packKeptObjects boolean indicating whether to include objects in `.keep` files
     *                        when repacking.
     * @since 5.13.3
     */
     ...
     * Default setting: {@value #DEFAULT_BITMAP_CONTIGUOUS_COMMIT_COUNT}
     *
     * @param count the count of most recent commits for which to build bitmaps
     * @since 4.2
     */
     ...
     * Default setting: {@value #DEFAULT_BITMAP_RECENT_COMMIT_COUNT}
     *
     * @param count the count for switching between recent and distant spans
     * @since 4.2
     */
     ...
     * Default setting: {@value #DEFAULT_BITMAP_RECENT_COMMIT_SPAN}
     *
     * @param span the span of commits when building bitmaps for recent history
     * @since 4.2
     */
     ...
     * Default setting: {@value #DEFAULT_BITMAP_DISTANT_COMMIT_SPAN}
     *
     * @param span the span of commits when building bitmaps for distant history
     * @since 4.2
     */
     ...
     *
     * @param count the count of branches deemed "excessive"
     * @since 4.2
     */
     ...
     * Default setting: {@value #DEFAULT_BITMAP_EXCESSIVE_BRANCH_TIP_COUNT}
     *
     * @param count the count of branch tips deemed "excessive"
     * @since 6.9
     */
     ...
     *
     * @param ageInDays the age in days that marks a branch as "inactive"
     * @since 4.2
     */
     ...
     *
     * @param timeout max time allowed during the search for reuse phase
     *                <p>
     *                Default setting: {@link #DEFAULT_SEARCH_FOR_REUSE_TIMEOUT}
     * @since 5.13
     */
     ...
     *
     * @param minBytesForObjSizeIndex minimum size (inclusive) of an object to be included in the
