...
public class WindowCacheConfig {
     ...
     *
     * @param fdLimit maximum number of streams to open at a time. Open packs count
     ...
     *
     * @param useStrongRefs if @{code true} the cache strongly references cache pages
     ...
     *
     * @param useStrongRefs if @{code true} the Pack strongly references cached indices
     *                      otherwise it uses {@link java.lang.ref.SoftReference}s which
     *                      can be evicted by the Java gc if heap is almost full
     * @since 6.7
     */
     ...
     *
     * @param usemmap {@code true} enables use of Java NIO virtual memory mapping
     ...
     * recently accessed objects, without delta chains.
     *
     * @param newLimit maximum number of bytes to cache in delta base cache for
     *                 inflated, recently accessed objects, without delta chains.
     */
     ...
     *
     * @param newLimit new byte limit for objects that must be streamed. Objects
     ...
     *
     * @param expose whether to register the JMX Bean
     * @since 5.8
     */
