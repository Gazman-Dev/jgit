...
public interface IMatcher {
     ...
     * @param dirOnly whether to match only directories
     ...
     * @param assumeDirectory true to assume this path as directory (even if it doesn't end
     *                        with a slash)
     * @param pathMatch       {@code true} if the match is for the full path: prefix-only
