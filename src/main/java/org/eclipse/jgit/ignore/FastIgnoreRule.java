...
public class FastIgnoreRule {
     ...
     *
     * @param pattern ignore pattern as described in <a href=
     ...
     *
     * @param path      Name pattern of the file, relative to the base directory of
     *                  this rule
     ...
     *                  this rule
     * @param directory Whether the target file is a directory or not
     * @param pathMatch {@code true} if the match is for the full path: see
