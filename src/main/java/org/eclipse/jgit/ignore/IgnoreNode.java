...
public class IgnoreNode {
     ...
     *
     * @param in input stream holding the standard ignore format. The caller is
     *           responsible for closing the stream.
     * @throws IOException Error thrown when reading an ignore file.
     */
     ...
     * Parse files according to gitignore standards.
     *
     * @param sourceName identifying the source of the stream
     * @param in         input stream holding the standard ignore format. The caller is
     *                   responsible for closing the stream.
     * @throws IOException Error thrown when reading an ignore file.
     * @since 5.11
     ...
     *
     * @param entryPath   the path to test. The path must be relative to this ignore
