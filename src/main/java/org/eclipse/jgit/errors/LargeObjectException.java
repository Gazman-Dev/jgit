...
public class LargeObjectException extends RuntimeException {
     ...
     *
     * @param id identity of the object that is too big to be loaded as a byte
     *           array in this JVM.
     */
     ...
     *
     * @param id the id of the object that is too large to process.
     */
    ...
    public static class ExceedsLimit extends LargeObjectException {
         ...
         *
         * @param limit the limit the caller imposed on the object.
