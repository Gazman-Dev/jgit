...
public abstract class TranslationBundleException extends RuntimeException {
     ...
     * @param bundleClass bundle class for which the exception occurred
     * @param locale      locale for which the exception occurred
     * @param cause       original exception that caused this exception. Usually thrown
