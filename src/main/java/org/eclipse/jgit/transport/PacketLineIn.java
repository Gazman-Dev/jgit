...
public class PacketLineIn {
     ...
     *
     * @param in    the input stream to consume.
     * @param limit bytes to read from the input; unlimited if set to 0.
     * @since 4.7
     */
     ...
     *
     * @param line       to parse
     * @param returnedId in case of {@link AckNackResult#ACK_COMMON ACK_COMMON}
     ...
     * @throws IOException on protocol or transport errors
     */
     ...
     * is encountered.
     * @throws IOException on failure to read the initial packet line.
     * @since 5.4
     */
