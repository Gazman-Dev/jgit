...
public class PushCertificateParser {
    ...
    private static interface StringReader {
         ...
         * @throws EOFException if EOF was reached.
     ...
     * </ul>
     *
     * @param r input reader; consumed only up until the end of the next
     *          signature in the input.
     * @return the parsed certificate, or null if the reader was at EOF.
     * @throws PackProtocolException if the certificate is malformed.
     * @throws IOException           if there was an error reading from the input.
     * @since 4.1
     */
     ...
     *
     * @param into destination repository for the push.
     * @param cfg  configuration for signed push.
     * @since 4.1
     */
     ...
     * disabled.
     * @throws IOException if the push certificate has missing or invalid fields.
     * @since 4.1
     */
     ...
     *
     * @param pckIn     where we take the push certificate header from.
     * @param stateless affects nonce verification. When {@code stateless = true} the
     *                  {@code NonceGenerator} will allow for some time skew caused by
     *                  clients disconnected and reconnecting in the stateless smart
     *                  HTTP protocol.
     * @throws IOException if the certificate from the client is badly malformed or the
     ...
     *
     * @param pckIn where we read the signature from.
     * @throws IOException if the signature is invalid.
     * @since 4.0
     */
     ...
     * Add a command to the signature.
     *
     * @param line the line read from the wire that produced this
     *             command, with optional trailing newline already trimmed.
     * @throws PackProtocolException if the raw line cannot be parsed to a command.
     * @since 4.0
     */
