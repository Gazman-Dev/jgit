...
abstract class WalkRemoteObjectDatabase {
     ...
     * @throws IOException The connection is unable to read the remote repository's list
     ...
     *
     * @param path location of the file to read, relative to this objects
     *             directory (e.g.
     ...
     * @throws FileNotFoundException the requested file does not exist at the given location.
     * @throws IOException           The connection is unable to read the remote's file, and the
     ...
     *
     * @param location the location of the new alternate, relative to the current
     *                 object database.
     * @return a new database connection that can read from the specified
     * alternate.
     * @throws IOException The database connection cannot be established with the
     ...
     *
     * @param path name of the item to be removed, relative to the current object
     *             database.
     * @throws IOException deletion is not supported, or deletion failed.
     */
     ...
     *
     * @param path        name of the file to write, relative to the current object
     *                    database.
     * @param monitor     (optional) progress monitor to post write completion to during
     *                    the stream's close method.
     * @param monitorTask (optional) task name to display during the close method.
     ...
     * @param path name of the file to write, relative to the current object
     *             database.
     * @param data complete new content of the file.
     * @throws IOException writing is not supported, or attempting to write the file
     *                     failed, possibly due to permissions or remote disk full, etc.
     */
     ...
     *
     * @param name name of the ref within the ref space, for example
     ...
     * @param name  name of the ref within the ref space, for example
     *              <code>refs/heads/pu</code>.
     * @param value new value to store in this ref. Must not be null.
     * @throws IOException writing is not supported, or attempting to write the file
     *                     failed, possibly due to permissions or remote disk full, etc.
     */
     ...
     *
     * @param packNames names of available pack files, in the order they should appear
     ...
     * object database.
     *
     * @param listPath location of the alternate file to read, relative to this
     ...
     *
     * @param avail return collection of references. Any existing entries will be
     *              replaced if they are found in the packed-refs file.
     * @throws TransportException an error occurred reading from the packed refs file.
     */
    ...
    static final class FileStream {
         ...
         *
         * @param i stream containing the file data. This stream will be
         ...
         * @param i stream containing the file data. This stream will be
         *          closed by the caller when reading is complete.
         * @param n total number of bytes available for reading through
         *          <code>i</code>.
         */
