...
abstract class HttpAuthMethod {
     ...
     * @param ignoreTypes authentication types to be ignored.
     ...
     *
     * @param type authentication method type
     */
     ...
     *
     * @param uri                 the URI used to create the connection.
     * @param credentialsProvider the credentials provider, or null. If provided,
