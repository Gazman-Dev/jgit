...
public class URIish implements Serializable {
     ...
     * @throws URISyntaxException if {@code s} was null or couldn't be parsed
     */
     ...
     *
     * @param s                   The Java String to encode (may contain any character)
     * @param escapeReservedChars true to escape URI reserved characters
     * @param encodeNonAscii      encode any non-ASCII characters
     ...
     *
     * @param u the source URL to convert from.
     */
    public URIish(URL u) {
     ...
     *
     * @param n the new value for host.
     ...
     *
     * @param n the new value for scheme.
     * @return a new URI with the updated value.
     */
     ...
     *
     * @param n the new value for path.
     * @return a new URI with the updated value.
     */
     ...
     * @param n the new value for path.
     * @return a new URI with the updated value.
     * @throws URISyntaxException if URI couldn't be parsed from String
     */
     ...
     *
     * @param n the new value for user.
     * @return a new URI with the updated value.
     */
     ...
     *
     * @param n the new value for password.
     * @return a new URI with the updated value.
     */
     ...
     *
     * @param n the new value for port.
     * @return a new URI with the updated value.
     */
     ...
     * {@code null}.
     * @throws IllegalArgumentException if it's impossible to determine a humanish part, or path is
     *                                  {@code null} or empty
     * @see #getPath
     */
