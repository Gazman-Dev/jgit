...
final class ProtocolV2Parser {
     ...
     *
     * @param pckIn incoming lines
     * @return A FetchV2Request populated with information received from the
     * wire.
     * @throws PackProtocolException incompatible options, wrong type of arguments or other issues
     *                               where the request breaks the protocol.
     * @throws IOException           an IO error prevented reading the incoming message.
     */
     ...
     *
     * @param pckIn incoming lines. This method will read until an END line.
     * @return a LsRefsV2Request object with the data received in the wire.
     * @throws PackProtocolException for inconsistencies in the protocol (e.g. unexpected lines)
     * @throws IOException           reporting problems reading the incoming messages from the
     *                               wire
     */
