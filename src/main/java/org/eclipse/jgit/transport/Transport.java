...
public abstract class Transport implements AutoCloseable {
     ...
     * @throws URISyntaxException    the location is not a remote defined in the configuration
     ...
     * @throws NotSupportedException case that is not supported by JGit
     * @throws TransportException    if transport failed
     */
    @SuppressWarnings("ModifyCollectionInEnhancedForLoop")
     ...
     * @throws IOException when problem occurred during conversion or specification set
     ...
     *
     * @param redirect {@link PrintStream} to use; if {@code null},
     ...
     *
     * @param useBitmaps false to disable use of bitmaps for push, true otherwise.
     * @since 6.4
     */
     ...
     * remote branch history.
     *
     * @param depth the depth, or {@code null} to unset the depth
     * @since 6.3
     */
     ...
     * @throws NotSupportedException this transport implementation does not support fetching
     *                               objects.
     * @throws TransportException    the remote connection could not be established or object
     ...
     * @throws NotSupportedException this transport implementation does not support pushing
     *                               objects.
     * @throws TransportException    the remote connection could not be established or object
     ...
     * @throws NotSupportedException the implementation does not support fetching.
     * @throws TransportException    the remote connection could not be established.
     */
     ...
     * @throws NotSupportedException the implementation does not support pushing.
     * @throws TransportException    the remote connection could not be established
     */
