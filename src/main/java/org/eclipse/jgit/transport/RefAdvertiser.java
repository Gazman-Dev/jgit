...
public abstract class RefAdvertiser {
     ...
     *
     * @param src the repository to read from.
     */
     ...
     *
     * @param b true if this advertiser should advertise using the protocol v2
     ...
     * </ul>
     *
     * @param deref true to show the dereferenced value of a tag as the special
     ...
     * </ul>
     *
     * @param name the name of a single protocol capability supported by the
     ...
     * @param value value. If null the capability will not be added.
     * @since 4.0
     */
     ...
     * </ul>
     *
     * @param from The symbolic ref, e.g. "HEAD"
     * @param to   The real ref it points to, e.g. "refs/heads/master"
     * @since 3.6
     */
     ...
     *
     * @param refs zero or more refs to format for the client. The collection is
     *             sorted before display if necessary, and therefore may appear
     *             in any order.
     * @return set of ObjectIds that were advertised to the client.
     * @throws IOException the underlying output stream failed to write out an
     ...
     *
     * @param id identity of the object that is assumed to exist.
     * @throws IOException the underlying output stream failed to write out an
     *                     advertisement record.
     */
     ...
     *
     * @param id      the object to advertise.
     * @param refName name of the reference to advertise the object as, can be any
     ...
     *
     * @param line the advertisement line to be written. The line always ends
