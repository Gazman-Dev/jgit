...
public final class LsRefsV2Request {
    ...
    public static final class Builder {
         ...
         *
         * @param value the client-supplied agent capability, without leading
         *              "agent="
         * @return this builder
         * @since 5.2
         */
         ...
         *
         * @param value the client-supplied session-id capability, without leading
         *              "session-id="
         * @return this builder
         * @since 6.4
         */
