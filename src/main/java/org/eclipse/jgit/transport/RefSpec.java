...
public class RefSpec implements Serializable {
     ...
     *
     * @param s ref spec component - string to test. Can be null.
     ...
     * </ul>
     *
     * @param spec string describing the specification.
     * @param mode whether to allow a wildcard on one side without a wildcard on
     *             the other.
     * @throws IllegalArgumentException the specification is invalid.
     * @since 4.5
     */
     ...
     *
     * @param forceUpdate new value for force update in the returned instance.
     ...
     *
     * @param source new value for source in the returned instance.
     * @return a new RefSpec with source as specified.
     * @throws IllegalStateException There is already a destination configured, and the wildcard
     ...
     *
     * @param destination new value for destination in the returned instance.
     * @return a new RefSpec with destination as specified.
     * @throws IllegalStateException There is already a source configured, and the wildcard status
     ...
     * @param destination new value for destination in the returned instance.
     * @return a new RefSpec with destination as specified.
     * @throws IllegalArgumentException The wildcard status of the new source disagrees with the
     ...
     *
     * @param r ref name that should be tested.
     ...
     *
     * @param r ref whose name should be tested.
     * @return true if the names match; false otherwise.
     */
     ...
     *
     * @param r a ref name that matched our source specification. Could be a
     *          wildcard also.
     ...
     * wildcard.
     * @throws IllegalStateException when the RefSpec was constructed with wildcard mode that
     ...
     * otherwise expansion results may be unpredictable.
     *
     * @param r a ref that matched our source specification. Could be a
     *          wildcard also.
     * @return a new specification expanded from provided ref name. Result
     * specification is wildcard if and only if provided ref name is
     * wildcard.
     ...
     * otherwise expansion results may be unpredictable.
     *
     * @param r a ref name that matched our destination specification. Could
     *          be a wildcard also.
     * @return a new specification expanded from provided ref name. Result
     * specification is wildcard if and only if provided ref name is
     * wildcard.
     ...
     * otherwise expansion results may be unpredictable.
     *
     * @param r a ref that matched our destination specification.
     * @return a new specification expanded from provided ref name. Result
     * specification is wildcard if and only if provided ref name is
     * wildcard.
     * @throws IllegalStateException when the RefSpec was constructed with wildcard mode that
