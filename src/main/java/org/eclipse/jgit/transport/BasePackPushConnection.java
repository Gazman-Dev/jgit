...
public abstract class BasePackPushConnection extends BasePackConnection implements
     ...
     *
     * @param monitor      progress monitor to receive status updates.
     * @param refUpdates   update commands to be applied to the remote repository.
     * @param outputStream output stream to write sideband messages to
