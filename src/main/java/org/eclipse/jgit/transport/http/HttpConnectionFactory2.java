...
public interface HttpConnectionFactory2 extends HttpConnectionFactory {
    ...
    interface GitSession {
         ...
         *
         * @param connection to configure; created by the same
         *                   {@link HttpConnectionFactory} instance
         * @param sslVerify  whether SSL is to be verified
         * @return the configured {@code connection}
         * @throws IOException              if the connection cannot be configured
         * @throws GeneralSecurityException if the connection cannot be configured
         */
        @NonNull
