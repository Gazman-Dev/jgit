...
public interface FetchConnection extends Connection {
     ...
     * </p>
     *
     * @param monitor progress monitor to inform the end-user about the amount of
     ...
     * @param want    one or more refs advertised by this connection that the caller
     *                wants to store locally.
     * @param have    additional objects known to exist in the destination
     ...
     *                database. Connections should take this set as an addition to
     *                what is reachable through all Refs, not in replace of it.
     * @param out     OutputStream to write sideband messages to
     * @throws TransportException objects could not be copied due to a network failure,
     *                            protocol error, or error on remote side, or connection was
     *                            already used for fetch.
     * @since 3.0
