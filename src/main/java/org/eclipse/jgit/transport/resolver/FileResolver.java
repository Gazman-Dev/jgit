...
public class FileResolver<C> implements RepositoryResolver<C> {
     ...
     *
     * @param basePath  the base path all repositories are rooted under.
     * @param exportAll if true, exports all repositories, ignoring the check for the
     ...
     *
     * @param name name the repository will be published under.
     * @param db   the repository instance.
     */
     ...
     *
     * @param dir the directory to export. This directory must not itself be a
     ...
     * @param repositoryName name of the repository, as present in the URL.
     * @param db             the opened repository instance.
     * @return true if the repository is accessible; false if not.
     * @throws IOException the repository could not be accessed, the caller will claim
