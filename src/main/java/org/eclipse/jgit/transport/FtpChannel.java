...
public interface FtpChannel {
     ...
     *
     * @param timeout for establishing the FTP connection
     * @param unit    of the {@code timeout}
     ...
     * @throws IOException if the operation could not be performed remotely
     */
     ...
     *
     * @param path to delete
     * @throws IOException if the file does not exist or could otherwise not be deleted
     */
     ...
     *
     * @param path to delete
     * @throws IOException if the file exist but could not be deleted
     */
