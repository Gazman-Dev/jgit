...
public abstract class PackParser {
     ...
     *
     * @param odb database the parser will write its objects into.
     * @param src the stream the parser will read.
     */
     ...
     *
     * @param allow true to enable a thin pack.
     */
     ...
     *
     * @param check true to enable collision checking (strongly encouraged).
     * @since 4.1
     */
     ...
     *
     * @param b true if the EOF should be read; false if it is not checked.
     */
     ...
     *
     * @param e true if there is additional data in InputStream after pack.
     ...
     *
     * @param oc the checker instance; null to disable object checking.
     */
     ...
     * </pre>
     *
     * @param on true to enable the default checker; false to disable it.
     */
     ...
     *
     * @param msg if not null, the message to associate with the incoming data
     ...
     *
     * @param limit the Git object size limit. If zero then there is not limit.
     */
     ...
     *
     * @param nth index of the object in the stream. Must be between 0 and
     ...
     *
     * @param cmp comparison function, if null objects are stored by ObjectId.
     ...
     *
     * @param progress callback to provide progress feedback during parsing. If null,
     *                 {@link NullProgressMonitor} will be used.
     * @return the pack lock, if one was requested by setting
     * {@link #setLockMessage(String)}.
     * @throws IOException the stream is malformed, or contains corrupt objects.
     * @since 6.0
     */
     ...
     * Parse the pack stream.
     *
     * @param receiving receives progress feedback during the initial receiving
     *                  objects phase. If null,
     *                  {@link NullProgressMonitor} will be used.
     * @param resolving receives progress feedback during the resolving objects phase.
     * @return the pack lock, if one was requested by setting
     * {@link #setLockMessage(String)}.
     * @throws IOException the stream is malformed, or contains corrupt objects.
     * @since 6.0
     ...
     * @throws IOException the size cannot be read.
     */
     ...
     *
     * @param id   identity of the object to be checked.
     * @param type the type of the object.
     * @param data raw content of the object.
     * @throws CorruptObjectException if a corrupt object was found
     * @since 4.9
     */
     ...
     *
     * @param id        identity of the object to be tracked.
     * @param delta     if the object was previously an unresolved delta, this is the
     *                  delta object that was tracking it. Otherwise null.
     * @param deltaBase if the object was previously an unresolved delta, this is the
     ...
     *
     * @param raw buffer to copy data out of.
     * @param pos first offset within the buffer that is valid.
     * @param len number of bytes in the buffer that are valid.
     * @throws IOException the stream cannot be archived.
     */
     ...
     *
     * @param src where the data came from
     * @param raw buffer to read data from.
     * @param pos first offset within buffer that is valid.
     * @param len number of bytes in buffer that are valid.
     * @throws IOException the stream cannot be archived.
     */
     ...
     *
     * @param obj      the object info, populated.
     * @param typeCode the type of the object.
     * @param data     inflated data for the object.
     * @throws IOException the object cannot be archived.
     */
     ...
     *
     * @param objCnt number of objects expected in the stream.
     * @throws IOException the implementation refuses to work with this many objects.
     */
     ...
     *
     * @param hash the trailing 20 bytes of the pack, this is a SHA-1 checksum of
     ...
     *
     * @param typeCode type of the base object.
     * @param data     complete content of the base object.
     * @param info     packed object information for this base. Implementors must
     ...
     * @throws IOException the base could not be included into the pack.
     */
     ...
     * have been resolved.
     *
     * @throws IOException the pack cannot be archived.
     */
     ...
     *
     * @param obj  the object position to begin reading from. This is from
     *             {@link #newInfo(AnyObjectId, UnresolvedDelta, ObjectId)}.
     * @param info object to populate with type and size.
     * @return the {@code info} object.
     * @throws IOException the database cannot reposition to this location.
     */
     ...
     * reset its internal CRC instance during this method call.
     *
     * @param delta the object position to begin reading from. This is an instance
     ...
     *
     * @param dst the buffer to copy read data into.
     * @param pos position within {@code dst} to start copying data into.
     * @param cnt ideal target number of bytes to read. Actual read length may
     *            be shorter.
     * @return number of bytes stored.
     * @throws IOException the database cannot be accessed.
     */
     ...
     *
     * @param oldCRC the prior CRC that was recorded during the first scan of the
     ...
     *
     * @param streamPosition position of this object in the incoming stream.
     * @param type           type of the object; one of
     *                       {@link Constants#OBJ_COMMIT},
     *                       {@link Constants#OBJ_TREE},
     *                       {@link Constants#OBJ_BLOB}, or
     *                       {@link Constants#OBJ_TAG}.
     * @param inflatedSize   size of the object when fully inflated. The size stored within
     *                       the pack may be larger or smaller, and is not yet known.
     * @throws IOException the object cannot be recorded.
     */
     ...
     *
     * @param deltaStreamPosition position of this object in the incoming stream.
     * @param baseStreamPosition  position of the base object in the incoming stream. The base
     ...
     * @param inflatedSize        size of the delta when fully inflated. The size stored within
     *                            the pack may be larger or smaller, and is not yet known.
     * @throws IOException the object cannot be recorded.
     */
     ...
     *
     * @param deltaStreamPosition position of this object in the incoming stream.
     * @param baseId              name of the base object. This object may be later in the
    ...
    public static class UnresolvedDelta {
         ...
         *
         * @param crc32 the CRC-32 checksum of the stored delta data.
         */
