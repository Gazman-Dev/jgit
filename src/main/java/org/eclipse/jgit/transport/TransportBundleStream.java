...
public class TransportBundleStream extends Transport implements TransportBundle {
     ...
     *
     * @param db  repository the fetched objects will be loaded into.
     * @param uri symbolic name of the source of the stream. The URI can
     *            reference a non-existent resource. It is used only for
     *            exception reporting.
     * @param in  the stream to read the bundle from.
     */
