...
public interface NonceGenerator {
     ...
     *
     * @param db        The repository which should be used to obtain a unique String
     ...
     *
     * @param received  The nonce which was received from the server
     * @param sent      The nonce which was originally sent out to the client.
     * @param db        The repository which should be used to obtain a unique String
     *                  such that the pusher cannot forge nonces by pushing to another
     *                  repository at the same time as well and reusing the nonce.
     * @param allowSlop If the receiving backend is able to generate slop. This is
     ...
     * @param slop      If `allowSlop` is true, this specifies the number of seconds
