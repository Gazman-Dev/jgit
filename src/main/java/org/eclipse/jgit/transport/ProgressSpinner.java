...
public class ProgressSpinner {
     ...
     *
     * @param title      description of the task, suitable for human viewing.
     * @param delay      delay to wait before displaying anything at all.
     * @param delayUnits unit for {@code delay}.
     */
     ...
     *
     * @param result text to print after the task's title
     *               {@code "$title ... $result"}.
     */
