...
public class PacketLineOut {
     ...
     *
     * @param outputStream  stream.
     * @param enableLogging {@code false} to suppress all logging; {@code true} to log
     *                      normally
     * @since 5.11
     */
     ...
     *
     * @param flushOnEnd if true, a flush-pkt written during {@link #end()} also
     ...
     *
     * @param value If true, when writing packet lines, add, as the first byte, a
     ...
     * @throws IOException the packet could not be written, the stream is corrupted as
     ...
     *
     * @param packet the packet to write; the length of the packet is equal to the
     ...
     * @param pos first index within {@code buf}.
     ...
     *
     * @throws IOException the marker could not be written, the stream is corrupted
     ...
     *
     * @throws IOException the end marker could not be written, the stream is corrupted
     ...
     *
     * @throws IOException the underlying stream failed to flush.
     */
