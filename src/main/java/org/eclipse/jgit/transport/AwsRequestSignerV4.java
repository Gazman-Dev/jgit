...
public final class AwsRequestSignerV4 {
     ...
     * @param contentLength     The content length of the data being sent in the request
     * @param bodyHash          Hex-encoded SHA-256 hash of the data being sent in the request
     * @param serviceName       The signing name of the AWS service (e.g. "s3").
     * @param regionName        The name of the AWS region that will handle the request (e.g.
     *                          "us-east-1").
     ...
     *
     * @param url The AWS service endpoint URL, including the path to any
     *            resource.
