...
public class RemoteConfig implements Serializable {
     ...
     *
     * @param rc the existing configuration to get the remote settings from.
     ...
     * @throws URISyntaxException one of the URIs within the remote's configuration is invalid.
     */
     ...
     * @param rc         the existing configuration to get the remote settings from.
     *                   The configuration must already be loaded into memory.
     * @param remoteName subsection key indicating the name of this remote.
     * @throws URISyntaxException one of the URIs within the remote's configuration is invalid.
     */
     ...
     *
     * @param rc the configuration file to store ourselves into.
     */
     ...
     *
     * @param toAdd the new URI to add to this remote.
     ...
     *
     * @param toRemove the URI to remove from this remote.
     * @return true if the URI was added; false if it already exists.
     */
     ...
     *
     * @param s the new specification to add.
     ...
     *
     * @param specs list of fetch specifications to set. List is copied, it can be
     ...
     *
     * @param specs list of push specifications to set. List is copied, it can be
     *              modified after this call.
     */
     ...
     *
     * @param s the specification to remove.
     ...
     *
     * @param m true to automatically delete remote refs during push.
     */
