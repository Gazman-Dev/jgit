...
abstract class BasePackConnection extends BaseConnection {
     ...
     *
     * @param myIn  input stream to receive data from the peer. Caller must ensure
     *              the input is buffered, otherwise read performance may suffer.
     * @param myOut output stream to transmit data to the peer. Caller must ensure
     ...
     * @throws TransportException the reference list could not be scanned.
     */
     ...
     *
     * @param refSpecs           to produce ref prefixes from if the server supports git
     *                           protocol V2
     * @param additionalPatterns to use for ref prefixes if the server supports git protocol V2
     * @throws TransportException if the command could not be run or its output not be read
     */
     ...
     * </p>
     *
     * @param refMap  a non-null, modifiable, Map to update, and the provider of
     *                symref targets.
     ...
     *
     * @param b a {@link StringBuilder} object.
     */
