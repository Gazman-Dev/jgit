...
public class ReceiveCommand {
     ...
     *
     * @param commands commands to mark as failed.
     * @since 4.2
     */
     ...
     *
     * @param oldId     expected oldId. May be {@code zeroId} to create.
     * @param newTarget new target; must begin with {@code "refs/"}.
     * @param name      name of the reference to make symbolic.
     ...
     *
     * @param oldTarget expected old target. May be null to create.
     * @param newTarget new target; must begin with {@code "refs/"}.
     * @param name      name of the reference to make symbolic.
     * @return command instance.
     * @since 4.10
     ...
     *
     * @param oldTarget expected old target.
     * @param newId     new object identifier. May be {@code zeroId()} to delete.
     * @param name      name of the reference to convert from symbolic.
     * @return command instance.
     * @since 4.10
     */
     ...
     * {@link ReceivePack}.
     *
     * @param oldId the expected old object id; must not be null. Use
     *              {@link ObjectId#zeroId()} to indicate a
     *              ref creation.
     * @param newId the new object id; must not be null. Use
     *              {@link ObjectId#zeroId()} to indicate a
     *              ref deletion.
     * @param name  name of the ref being affected.
     */
     ...
     * {@link ReceivePack}.
     *
     * @param oldId the old object id; must not be null. Use
     *              {@link ObjectId#zeroId()} to indicate a
     *              ref creation.
     * @param newId the new object id; must not be null. Use
     *              {@link ObjectId#zeroId()} to indicate a
     *              ref deletion.
     * @param name  name of the ref being affected.
     * @param type  type of the command. Must be
     *              {@link Type#CREATE}
     *              if {@code
     *              oldId} is zero, or
     *              {@link Type#DELETE}
     ...
     * @param newSymref new target, must begin with {@code "refs/"}. Use {@code null}
     ...
     * Create a command to switch a reference from symbolic to object.
     *
     * @param oldSymref expected old target. Use {@code null} to indicate a ref
     *                  creation.
     * @param newId     the new object id; must not be null. Use
     ...
     * Create a command to switch a symbolic reference's target.
     *
     * @param oldTarget expected old target. Use {@code null} to indicate a ref
     *                  creation.
     * @param newTarget new target. Use {@code null} to indicate a ref deletion.
     * @param name      name of the reference to make symbolic.
     * @since 4.10
     */
     ...
     *
     * @param msg          the message to describe this change. If null and appendStatus is
     ...
     *
     * @param s the new status code for this command.
     */
     ...
     * Set the status of this command.
     *
     * @param s new status code for this command.
     * @param m optional message explaining the new status.
     */
     ...
     *
     * @param walk an instance to perform the merge test with. The caller must
     *             allocate and release this object.
     * @throws IOException either oldId or newId is not accessible in the repository
     ...
     *
     * @param r the new result code for this command.
     */
