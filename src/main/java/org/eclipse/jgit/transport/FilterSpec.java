...
public final class FilterSpec {
     ...
     * </ul>
     *
     * @param filterLine the content of the "filter" line in the protocol
     * @return a FilterSpec representing the given filter
     * @throws PackProtocolException invalid filter because due to unrecognized format or
     ...
     *
     * @param types set of permitted object types, for use in "blob:none" and
     *              "object:none" filters
     ...
     * Specify blob limit
     *
     * @param blobLimit the blob limit in a "blob:[limit]" filter line
     ...
     *
     * @param treeDepthLimit the tree depth limit in a "tree:[depth]" filter line
     ...
     *
     * @param type a Git object type, such as
