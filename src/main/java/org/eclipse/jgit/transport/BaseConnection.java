...
public abstract class BaseConnection implements Connection {
     ...
     *
     * @param agent remote peer agent string.
     * @since 4.0
     */
     ...
     *
     * @param all the complete list of refs the remote has to offer. This map
     ...
     *
     * @throws TransportException if operation was already marked as started.
     */
     ...
     *
     * @param writer the writer that messages will be delivered to. The writer's
