...
public class TestProtocol<C> extends TransportProtocol {
     ...
     *
     * @param uploadPackFactory  factory for creating
     *                           {@link UploadPack} used by all
     *                           connections from this protocol instance.
     * @param receivePackFactory factory for creating
