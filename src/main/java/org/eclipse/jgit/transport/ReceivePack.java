...
public class ReceivePack {
     ...
     *                        were advertised.
     * @param additionalHaves explicit set of additional haves to claim as advertised. If
     ...
     *
     * @param e {@code true} if there is additional data in InputStream after
     *          pack.
     */
     ...
     *
     * @param check {@code true} to enable checking received objects; false to
     ...
     *
     * @param canCreate {@code true} to permit create ref commands to be processed.
     */
     ...
     *
     * @param canDelete {@code true} to permit delete ref commands to be processed.
     */
     ...
     *
     * @param canDelete {@code true} to permit deletion of branches from the
     *                  {@code refs/heads/} namespace.
     * @since 3.6
     */
     ...
     *
     * @param canRewind {@code true} to permit the client to ask for non-fast-forward
     *                  updates of an existing ref.
     */
     ...
     * transaction.
     *
     * @param atomic {@code true} to perform the client's commands as a single
     *               atomic transaction.
     * @since 4.4
     */
     ...
     *
     * @param limit command limit in bytes; if 0 there is no limit.
     * @since 4.7
     */
     ...
     *
     * @param limit discard limit in bytes; if 0 there is no limit; if -1 the
     ...
     *
     * @param limit the pack size limit, in bytes
     * @since 3.3
     */
     ...
     * otherwise.
     * @throws RequestNotYetReadException if the client's request has not yet been read from the wire,
     ...
     *
     * @param allow true to allow clients to request quiet behavior; false to
     ...
     *
     * @param allow true to optionally accept option strings from the client.
     * @since 4.5
     */
     ...
     *
     * @param cfg new configuration; if this object is null or its
     ...
     *
     * @param receiveCommandErrorHandler the error handler
     * @since 5.7
     */
     ...
     * @throws IllegalStateException if called before the pack has been received
     * @since 3.3
     */
     ...
     *
     * @param input    raw input to read client commands and pack data from. Caller
     *                 must ensure the input is buffered, otherwise read performance
     *                 may suffer.
     * @param output   response back to the Git network client. Caller must ensure
     ...
     * connectivity checks).
     *
     * @throws IOException                  an error occurred during unpacking or connectivity checking.
     * @throws LargeObjectException         an large object needs to be opened for the check.
     * @throws SubmoduleValidationException fails to validate the submodule.
     */
     ...
     *
     * @throws IOException the pack could not be unlocked.
     */
     ...
     * @throws ServiceMayNotContinueException the hook denied advertisement.
     */
     ...
     * @throws IOException request line cannot be read.
     */
     ...
     *
     * @param name protocol name identifying the capability.
     ...
     *
     * @throws IOException an error occurred reading or indexing the pack.
     */
     ...
     *
     * @param want desired status to filter by.
     ...
     *
     * @param unpackError an error that occurred during unpacking, or {@code null}
     * @throws IOException an error occurred writing the status report.
     * @since 5.6
     */
     ...
     *
     * @param cert the push certificate to set.
     * @since 4.1
     */
     ...
     * the normal {@link #recvCommands()} flow.
     *
     * @param options the list of options supplied by the client. The
     ...
     *
     * @param h the hook instance; may be null to disable the hook.
     */
     ...
     *
     * @param unpackErrorHandler the unpackErrorHandler
     * @since 5.7
     */
     ...
     *
     * @param echo if true this class will report command failures as warning
