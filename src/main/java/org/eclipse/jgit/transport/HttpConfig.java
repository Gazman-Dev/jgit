...
public class HttpConfig {
     ...
     *
     * @param config to read the {@link HttpConfig} from
     * @param uri    to get the configuration values for
     */
     ...
     *
     * @param names to match against the {@code uri}
     * @param uri   to find a match for
