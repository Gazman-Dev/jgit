...
public class NoteMap implements Iterable<Note> {
     ...
     *
     * @param noteRefName a {@link String} object.
     ...
     *
     * @param reader reader to scan the note branch with. This reader may be
     *               retained by the NoteMap for the life of the map in order to
     *               support lazy loading of entries.
     * @param commit the revision of the note branch to read.
     * @return the note map read from the commit.
     * @throws IOException                  the repository cannot be accessed through the reader.
     * @throws CorruptObjectException       a tree object is corrupt and cannot be read.
     * @throws IncorrectObjectTypeException a tree object wasn't actually a tree.
     * @throws MissingObjectException       a reference tree object doesn't exist.
     */
     ...
     *               retained by the NoteMap for the life of the map in order to
     *               support lazy loading of entries.
     * @param tree   the note tree to read.
     ...
     *               retained by the NoteMap for the life of the map in order to
     *               support lazy loading of entries.
     * @param treeId the note tree to read.
     * @return the note map read from the tree.
     * @throws IOException                  the repository cannot be accessed through the reader.
     * @throws CorruptObjectException       a tree object is corrupt and cannot be read.
     * @throws IncorrectObjectTypeException a tree object wasn't actually a tree.
     ...
     *
     * @param root   the root bucket of this note map
     * @param reader reader to scan the note branch with. This reader may be
     *               retained by the NoteMap for the life of the map in order to
     *               support lazy loading of entries.
     ...
     * @throws IOException a portion of the note space is not accessible.
     */
     ...
     * </pre>
     *
     * @param id        object to lookup the note of.
     * @param sizeLimit maximum number of bytes to return. If the note data size is
     ...
     * is defined, null.
     * @throws LargeObjectException   the note data is larger than {@code sizeLimit}.
     * @throws MissingObjectException the note's blob does not exist in the repository.
     * @throws IOException            the note's blob cannot be read from the repository
     */
     ...
     *
     * @param noteOn   the object to attach the note to. This same ObjectId can later
     *                 be used as an argument to {@link #get(AnyObjectId)} or
     *                 {@link #getCachedBytes(AnyObjectId, int)} to read back the
     *                 {@code noteData}.
     * @param noteData data to associate with the note. This must be the ObjectId of
     ...
     * This method only updates the map in memory.
     *
     * @param noteOn the object to remove the note from.
     * @throws IOException a portion of the note space is not accessible.
     */
     ...
     *
     * @param inserter inserter to use when writing trees to the object database.
     ...
     * @throws IOException a tree could not be written.
     */
