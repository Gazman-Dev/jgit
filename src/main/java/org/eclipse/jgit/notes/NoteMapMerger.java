...
public class NoteMapMerger {
     ...
     * @param noteMerger            note merger for merging conflicting changes on a note
     * @param nonNotesMergeStrategy merge strategy for merging non-note entries
     */
     ...
     * @param ours      ours version
     * @param theirs    theirs version
