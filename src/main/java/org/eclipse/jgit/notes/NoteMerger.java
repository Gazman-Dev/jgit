...
public interface NoteMerger {
     ...
     * @throws NotesMergeConflictException in case there was a merge conflict which this note merger
     *                                     couldn't resolve
     * @throws IOException                 in case the reader or the inserter would throw an
