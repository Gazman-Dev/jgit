...
public final class Subsequence<S extends Sequence> extends Sequence {
     ...
     *
     * @param <S>    type of returned Sequence
     * @param a      the A sequence.
     * @param region the region of {@code a} to create a subsequence around.
     ...
     * @param region the region of {@code b} to create a subsequence around.
     ...
     *
     * @param <S> type of returned Sequence
     * @param e   edit to adjust in-place. Prior to invocation the indexes are
     ...
     *
     * @param <S>   type of returned Sequence
     * @param edits edits to adjust in-place. Prior to invocation the indexes are
     *              in terms of the two subsequences; after invocation the indexes
     *              are in terms of the base sequences.
     * @param a     the A sequence.
     * @param b     the B sequence.
     ...
     *
     * @param base  the real sequence.
     * @param begin First element index of {@code base} that will be part of this
     *              new subsequence. The element at {@code begin} will be this
     *              sequence's element 0.
     * @param end   One past the last element index of {@code base} that will be
