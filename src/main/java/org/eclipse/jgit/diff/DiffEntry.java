...
public class DiffEntry {
     ...
     *
     * @param walk the TreeWalk to walk through. Must have exactly two trees.
     * @return headers describing the changed files.
     * @throws IOException              the repository cannot be accessed.
     * @throws IllegalArgumentException When given TreeWalk doesn't have exactly two trees.
     */
     ...
     *
     * @param walk         the TreeWalk to walk through. Must have exactly two trees and
     *                     when {@code includeTrees} parameter is {@code true} it can't
     *                     be recursive.
     * @param includeTrees include tree objects.
     * @return headers describing the changed files.
     * @throws IOException              the repository cannot be accessed.
     * @throws IllegalArgumentException when {@code includeTrees} is true and given TreeWalk is
     ...
     *                        be recursive.
     * @param includeTrees    include tree objects.
     * @param markTreeFilters array of tree filters which will be tested for each entry. If
     ...
     *
     * @param side which path to obtain.
     ...
     *
     * @param side which mode to obtain.
     * @return the mode.
     */
     ...
     *
     * @param index the index of the tree filter to check for (must be between 0
     ...
     * Get the object id.
     *
     * @param side the side of the id to get.
     * @return the object id; null if there is no index line
     */
