...
public class Edit {
     ...
     *
     * @param as beginA: start and end of region in sequence A; 0 based.
     * @param bs beginB: start and end of region in sequence B; 0 based.
     */
     ...
     * Create a new edit.
     *
     * @param as beginA: start of region in sequence A; 0 based.
     * @param ae endA: end of region in sequence A; must be &gt;= as.
     * @param bs beginB: start of region in sequence B; 0 based.
     * @param be endB: end of region in sequence B; must be &gt; = bs.
     */
     ...
     *
     * @param amount the region is shifted by this amount, and can be positive or
     *               negative.
     * @since 4.8
     */
     ...
     *
     * @param cut the cut point. The beginning A and B points are used as the
     ...
     *
     * @param cut the cut point. The ending A and B points are used as the
