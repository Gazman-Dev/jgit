...
public class RawText extends Sequence {
     ...
     *
     * @param input the content array. The object retains a reference to this
     ...
     * @param input   the content array. The object retains a reference to this
     *                array, so it should be immutable.
     * @param lineMap an array with 1-based offsets for the start of each line.
     ...
     * output lines.
     *
     * @param out stream to copy the line data onto.
     * @param i   index of the line to extract. Note this is 0-based, so line
     *            number 1 is actually index 0.
     * @throws IOException the stream write operation failed.
     */
     ...
     *
     * @param begin  index of the first line to extract. Note this is 0-based, so
     *               line number 1 is actually index 0.
     * @param end    index of one past the last line to extract.
     * @param dropLF if true the trailing LF ('\n') of the last returned line is
     *               dropped, if present.
     ...
     *
     * @param start first byte of the content to decode.
     * @param end   one past the last byte of the content to decode.
     ...
     * closing the stream.
     *
     * @param raw input stream containing the raw file content.
     ...
     *
     * @param raw    the raw file content.
     * @param length number of bytes in {@code raw} to evaluate. This should be
     ...
     * is binary.
     *
     * @param ldr       the ObjectLoader for the blob
     * @param threshold if the blob is larger than this size, it is always assumed to
     *                  be binary.
