...
public abstract class DiffAlgorithm {
     ...
     * Get diff algorithm
     *
     * @param alg the diff algorithm for which an implementation should be
     *            returned
     ...
     * @param a   the first (also known as old or pre-image) sequence. Edits
     *            returned by this algorithm will reference indexes using the
     *            'A' side: {@link Edit#getBeginA()},
     *            {@link Edit#getEndA()}.
     * @param b   the second (also known as new or post-image) sequence. Edits
     *            returned by this algorithm will reference indexes using the
     ...
     * @param a   the first (also known as old or pre-image) sequence.
     * @param b   the second (also known as new or post-image) sequence.
