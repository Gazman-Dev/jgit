...
public class RenameDetector {
     ...
     *
     * @param repo the repository to use for rename detection
     */
     ...
     *
     * @param reader reader to obtain objects from the repository with.
     * @param cfg    diff config specifying rename detection options.
     * @since 3.0
     */
     ...
     *
     * @param score new rename score, must be within [0, 100].
     * @throws IllegalArgumentException the score was not within [0, 100].
     */
     ...
     * Set break score
     *
     * @param breakScore the similarity score required to keep modified file pairs
     ...
     *
     * @param limit new file limit. 0 means no limit; a negative number means no
     ...
     * @throws IOException file contents cannot be read from the repository.
     */
     ...
     * Detect renames in the current file set.
     *
     * @param pm report progress during the detection phases.
     * @return an unmodifiable list of {@link DiffEntry}s
     * representing all files that have been changed.
     * @throws IOException       file contents cannot be read from the repository.
     * @throws CanceledException if rename detection was cancelled
     */
     ...
     *
     * @param src  the DiffEntry to try to find a match for
     * @param list a list of DiffEntrys to search through
