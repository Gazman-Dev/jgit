...
public abstract class ContentSource {
     ...
     *
     * @param reader the reader to obtain blobs from.
     ...
     * TreeWalk.
     *
     * @param iterator the iterator to obtain source files through.
     ...
     * @param id   blob id of the file, if known.
    ...
    public static final class Pair {
         ...
         *
         * @param oldSource source to read the old side of a DiffEntry.
         * @param newSource source to read the new side of a DiffEntry.
         */
         ...
         * Determine the size of the object.
         *
         * @param side which side of the entry to read (OLD or NEW).
         * @param ent  the entry to examine.
         * @return the size in bytes.
         * @throws IOException the file cannot be accessed.
         */
