...
class GlobalBundleCache {
     ...
     * @param type   required bundle type
     * @return an instance of the required bundle type
     * @throws TranslationBundleLoadingException see {@link TranslationBundle#load(Locale)}
     * @throws TranslationStringMissingException see {@link TranslationBundle#load(Locale)}
     */
