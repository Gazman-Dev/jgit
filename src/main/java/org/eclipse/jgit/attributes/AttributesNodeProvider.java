...
public interface AttributesNodeProvider {
     ...
     * @throws IOException if an error is raised while parsing the attributes file
     */
     ...
     * @throws IOException java.io.IOException if an error is raised while parsing the
     *                     attributes file
