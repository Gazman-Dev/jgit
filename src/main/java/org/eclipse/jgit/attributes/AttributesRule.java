...
public class AttributesRule {
     ...
     *
     * @param pattern    Base pattern for the attributes rule. This pattern will be
     *                   parsed to generate rule parameters. It can not be
     *                   <code>null</code>.
     * @param attributes the rule attributes. This string will be parsed to read the
     *                   attributes.
     */
     ...
     *
     * @param relativeTarget Name pattern of the file, relative to the base directory of
     *                       this rule
     * @param isDirectory    Whether the target file is a directory or not
