...
public class FilterCommandRegistry {
     ...
     * {@link FilterCommand}
     *
     * @param filterCommandName the command name for which this factory is registered
     * @param factory           the factory responsible for creating
     ...
     *
     * @param filterCommandName the FilterCommandFactory's filter command name
     ...
     *
     * @param filterCommandName the name for which the registry should be checked
     ...
     *
     * @param filterCommandName The name for which a new
     *                          {@link FilterCommand} should be
     *                          created
     * @param db                the repository this command should work on
     * @param in                the {@link InputStream} this
     *                          {@link FilterCommand} should read
     *                          from
     * @param out               the {@link OutputStream} this
