...
public abstract class AbstractPlotRenderer<TLane extends PlotLane, TColor> {
     ...
     *
     * @param commit the commit to render in this cell. Must not be null.
     * @param h      total height (in pixels) of this cell.
     */
     ...
     * @param y   pixel coordinate of the baseline of the text. Implementations
