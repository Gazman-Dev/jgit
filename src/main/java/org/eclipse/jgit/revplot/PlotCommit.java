 ...
 *
 * @param <L> type of lane being used by the plotter.
 * @see PlotCommitList
 */
public class PlotCommit<L extends PlotLane> extends RevCommit {
     ...
     *
     * @param nth child index to obtain. Must be in the range 0 through
     *            {@link #getChildCount()}-1.
     * @return the specified child.
     * @throws ArrayIndexOutOfBoundsException an invalid child index was specified.
     */
     ...
     *
     * @param nth ref index to obtain. Must be in the range 0 through
     *            {@link #getRefCount()}-1.
     * @return the specified ref.
     * @throws ArrayIndexOutOfBoundsException an invalid ref index was specified.
     */
