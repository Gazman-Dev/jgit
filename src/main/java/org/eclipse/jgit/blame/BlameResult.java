...
public class BlameResult {
     ...
     *
     * @param gen the generator the result will consume records from.
     ...
     *
     * @param idx line to read data of, 0 based.
     ...
     * Check if the given result line has been annotated yet.
     *
     * @param start first index to examine.
     * @param end   last index to examine.
     * @return true if the data has been annotated, false otherwise.
     */
