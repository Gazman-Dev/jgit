...
public class BlameGenerator implements AutoCloseable {
     ...
     * @param path       initial path of the file to start scanning (relative to the
     *                   repository).
     */
     ...
     *
     * @param algorithm a {@link DiffAlgorithm}
     * @return {@code this}
     */
     ...
     *
     * @param comparator a {@link RawTextComparator}
     * @return {@code this}
     */
     ...
     *
     * @param start oldest commit to traverse from. The result file will be loaded
     *              from this commit's tree.
     * @param end   most recent commit to stop traversal at. Usually an active
     ...
     * @param start oldest commit to traverse from. The result file will be loaded
     *              from this commit's tree.
     * @param end   most recent commits to stop traversal at. Usually an active
     *              branch tip, tag, or HEAD.
     * @return {@code this}
     * @throws IOException the repository cannot be read.
     */
     ...
     * @throws IOException           repository cannot be read.
     * @throws IllegalStateException {@link #next()} has already been invoked.
     */
