...
public class StatusCommand extends GitCommand<Status> {
     ...
     * supported.
     *
     * @param path repository-relative path of file/directory to show status for
     ...
     *
     * @param workingTreeIt a working tree iterator
     * @return {@code this}
     */
     ...
     *
     * @param progressMonitor a {@link ProgressMonitor} object.
     * @return {@code this}
     * @since 3.1
     */
