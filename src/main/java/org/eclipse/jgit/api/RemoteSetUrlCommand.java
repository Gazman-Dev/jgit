...
public class RemoteSetUrlCommand extends GitCommand<RemoteConfig> {
     ...
     * The name of the remote to change the URL for.
     *
     * @param remoteName a remote remoteName
     * @return {@code this}
     * @since 5.3
     */
     ...
     *
     * @param uri an URL for the remote
     ...
     * The new URL for the remote.
     *
     * @param remoteUri an URL for the remote
     * @return {@code this}
     * @since 5.3
     */
     ...
     *
     * @param push <code>true</code> to set the push url, <code>false</code> to
     *             set the fetch url
     ...
     * Whether to change the push URL of the remote instead of the fetch URL.
     *
     * @param type the <code>UriType</code> value to set
     * @return {@code this}
     * @since 5.3
     */
