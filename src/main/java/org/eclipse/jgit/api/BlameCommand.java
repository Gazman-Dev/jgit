...
public class BlameCommand extends GitCommand<BlameResult> {
     ...
     * Set file path.
     *
     * @param filePath file path (with <code>/</code> as separator)
     * @return this command
     */
     ...
     * Set diff algorithm
     *
     * @param diffAlgorithm a {@link DiffAlgorithm} object.
     * @return this command
     */
     ...
     *
     * @param textComparator a {@link RawTextComparator}
     * @return this command
     */
