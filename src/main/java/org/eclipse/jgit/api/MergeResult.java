...
public class MergeResult {
     ...
     * @param base            the common base which was used to produce a content-merge. May
     *                        be <code>null</code> if the merge-result was produced without
     *                        computing a common base
     * @param mergedCommits   all the commits which have been merged together
     * @param mergeStatus     the status the merge resulted in
     * @param mergeStrategy   the used {@link MergeStrategy}
     * @param lowLevelResults merge results as returned by
     ...
     * @param lowLevelResults merge results as returned by
     *                        {@link org.eclipse.jgit.merge.ResolveMerger#getMergeResults()}
     * @param failingPaths    list of paths causing this merge to fail as returned by
     ...
     *
     * @param checkoutConflicts the conflicting files
     */
     ...
     * Add a conflict
     *
     * @param path              path of the file to add a conflict for
     * @param conflictingRanges the conflicts to set
     */
     ...
     *
     * @param path           path of the file to add a conflict for
     * @param lowLevelResult a {@link org.eclipse.jgit.merge.MergeResult}
     */
