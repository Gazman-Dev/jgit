...
public class AddCommand extends GitCommand<DirCache> {
     ...
     *
     * @param f a {@link WorkingTreeIterator}
     *          object.
     * @return {@code this}
     */
     ...
     *
     * @param update If set to true, the command only matches {@code filepattern}
     ...
     * </p>
     *
     * @param renormalize whether to renormalize tracked files
     * @return {@code this}
     * @since 6.6
     */
