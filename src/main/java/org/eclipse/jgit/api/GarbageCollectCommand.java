...
public class GarbageCollectCommand extends GitCommand<Properties> {
     ...
     *
     * @param expire minimal age of objects to be pruned.
     * @return this instance
     */
     ...
     *
     * @param aggressive whether to turn on or off aggressive mode
     * @return this instance
     * @since 3.6
     */
     ...
     *
     * @param preserveOldPacks whether to preserve old pack files
     * @return this instance
     * @since 4.7
     */
     ...
     *
     * @param prunePreserved whether to prune preserved pack files
     * @return this instance
     * @since 4.7
     */
     ...
     * @throws GitAPIException thrown if the repository statistics cannot be computed
     * @since 3.0
     */
