...
public class PushCommand extends
     ...
     *
     * @param receivePack name of the remote executable providing the receive-pack
     *                    service
     * @return {@code this}
     ...
     *
     * @param specs a {@link RefLeaseSpec} object.
     * @return {@code this}
     * @since 4.7
     */
     ...
     * force-with-lease push operation.
     *
     * @param specs list of {@code RefLeaseSpec}s
     * @return {@code this}
     * @since 4.7
     */
     ...
     * The ref specs to be used in the push operation
     *
     * @param specs list of {@link RefSpec}s
     * @return {@code this}
     */
     ...
     *
     * @param pushDefault {@link PushDefault} to set; if {@code null} the value defined
     ...
     *
     * @param ref the source reference. The remote name will match.
     * @return {@code this}.
     */
     ...
     * Add a reference to push.
     *
     * @param nameOrSpec any reference name, or a reference specification.
     * @return {@code this}.
     * @throws JGitInternalException the reference name cannot be resolved.
     */
     ...
     *
     * @param thinPack the thin-pack preference value
     * @return {@code this}
     */
     ...
     *
     * @param atomic whether to run the push atomically
     * @return {@code this}
     * @since 4.2
     */
     ...
     *
     * @param force whether to push forcefully
     * @return {@code this}
     */
     ...
     *
     * @param pushOptions a {@link List} of push option strings
     * @return {@code this}
     * @since 4.5
     */
