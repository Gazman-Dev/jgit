...
public class SubmoduleDeinitCommand
     ...
     *
     * @param repo repository this command works on
     */
     ...
     * @throws NoSuchSubmoduleException if any of the submodules which we might want to deinitialize
     *                                  don't exist
     */
    @Override
     ...
     *
     * @param revWalk used to walk commit graph
     ...
     *
     * @param force execute the command forcefully if there are local modifications
     * @return {@code this}
     */
    ...
    public static class NoSuchSubmoduleException extends GitAPIException {
         ...
         *
         * @param path path of non-existing submodule
         */
