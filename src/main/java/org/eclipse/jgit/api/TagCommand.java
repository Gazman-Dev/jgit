...
public class TagCommand extends GitCommand<Ref> {
     ...
     * @throws ServiceUnavailableException       if the tag should be signed but no signer can be found
     * @throws UnsupportedSigningFormatException if the tag should be signed but {@code gpg.format} is not
     ...
     *
     * @param tagger a {@link PersonIdent} object.
     * @return {@code this}
     */
     ...
     *
     * @param id a {@link RevObject} object.
     * @return {@code this}
     */
     ...
     *
     * @param forceUpdate whether this is a forced update
     * @return {@code this}
     */
     ...
     *
     * @param annotated whether this shall be an annotated tag
     * @return {@code this}
     * @since 3.0
     */
     ...
     * </p>
     *
     * @param signingKey signing key; {@code null} allowed
     * @return {@code this}
     * @since 5.11
     */
