...
public class CleanCommand extends GitCommand<Set<String>> {
     ...
     * @param inFiles A set of strings representing the files that have been cleaned
     ...
     *
     * @param paths the paths to set (with <code>/</code> as separator)
     * @return {@code this}
     */
     ...
     * deleted.
     *
     * @param force whether or not to delete git repositories
     * @return {@code this}
     * @since 4.5
     */
     ...
     *
     * @param dirs whether to clean directories too, or only files.
     * @return {@code this}
     */
     ...
     *
     * @param ignore whether to respect .gitignore or not.
     * @return {@code this}
     */
