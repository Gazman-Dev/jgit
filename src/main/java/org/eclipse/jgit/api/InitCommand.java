...
public class InitCommand implements Callable<Git> {
     ...
     *
     * @param directory the directory to init to
     ...
     *
     * @param gitDir the repository meta directory
     * @return this instance
     * @throws IllegalStateException if the combination of directory, gitDir and bare is illegal.
     *                               E.g. if for a non-bare repository directory and gitDir point
     *                               to the same directory of if for a bare repository both
     ...
     *
     * @param bare whether the repository is bare or not
     * @return this instance
     * @throws IllegalStateException if the combination of directory, gitDir and bare is illegal.
     *                               E.g. if for a non-bare repository directory and gitDir point
     *                               to the same directory of if for a bare repository both
     ...
     * master).
     *
     * @param branch initial branch name of the new repository
     * @return {@code this}
