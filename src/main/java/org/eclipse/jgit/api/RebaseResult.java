...
public class RebaseResult {
     ...
     *
     * @param status the overall rebase status
     ...
     *
     * @param failingPaths list of paths causing this rebase to fail
     * @return the RebaseResult
     */
     ...
     *
     * @param conflicts the list of conflicting paths
     * @return the RebaseResult
     */
     ...
     *
     * @param uncommittedChanges the list of paths
     * @return the RebaseResult
     */
