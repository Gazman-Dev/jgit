...
public class ArchiveCommand extends GitCommand<OutputStream> {
     ...
     * }
     *
     * @param <T> type representing an archive being created.
     */
    public static interface Format<T extends Closeable> {
         ...
         *
         * @param s underlying output stream to which to write the archive.
         * @param o options to apply to the underlying output stream. Keys are
         ...
         *
         * @param out    archive object from createArchiveOutputStream
         * @param tree   the tag, commit, or tree object to produce an archive for
         * @param path   full filename relative to the root of the archive (with
         *               trailing '/' for directories)
         * @param mode   mode (for example FileMode.REGULAR_FILE or
         *               FileMode.SYMLINK)
         * @param loader blob object with data for this entry (null for
         *               directories)
         * @throws IOException thrown by the underlying output stream for I/O errors
         * @since 4.7
         */
     ...
     * @throws JGitInternalException A different archival format with that name was
     *                               already registered.
     */
     ...
     * @throws JGitInternalException No such archival format was registered.
     */
     ...
     *
     * @param prefix string prefixed to filenames in archive (e.g., "master/").
     ...
     *
     * @param filename intended filename for the archive
     * @return this
     */
     ...
     * Set output stream
     *
     * @param out the stream to which to write the archive
     * @return this
     */
     ...
     * Set archive format
     *
     * @param fmt archive format (e.g., "tar" or "zip"). null means to choose
     ...
     *
     * @param options archive format options (e.g., level=9 for zip compression).
     * @return this
     * @since 4.0
     */
     ...
     *
     * @param paths file names (e.g <code>file1.c</code>) or directory names (e.g.
