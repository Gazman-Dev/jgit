...
public class CherryPickResult {
     ...
     *
     * @param newHead          commit the head points at after this cherry-pick
     * @param cherryPickedRefs list of successfully cherry-picked <code>Ref</code>'s
     */
     ...
     * Constructor for CherryPickResult
     *
     * @param failingPaths list of paths causing this cherry-pick to fail (see
