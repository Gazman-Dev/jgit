...
public class FetchCommand extends TransportCommand<FetchCommand, FetchResult> {
     ...
     *
     * @param recurse corresponds to the
     ...
     *
     * @param checkFetchedObjects whether to check objects for validity
     * @return {@code this}
     */
     ...
     * source
     *
     * @param removeDeletedRefs whether to remove deleted {@code Ref}s
     * @return {@code this}
     */
     ...
     *
     * @param specs String representation of {@code RefSpec}s
     * @return {@code this}
     * @since 4.9
     */
     ...
     * The ref specs to be used in the fetch operation
     *
     * @param specs one or multiple {@link RefSpec}s
     * @return {@code this}
     */
     ...
     *
     * @param thinPack the thin-pack preference
     * @return {@code this}
     */
     ...
     *
     * @param force whether to update refs affected by the fetch forcefully
     * @return this command
     * @since 5.0
     */
