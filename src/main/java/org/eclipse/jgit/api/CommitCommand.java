...
public class CommitCommand extends GitCommand<RevCommit> {
     ...
     * call to {@link #call()})
     *
     * @throws ServiceUnavailableException if signing service is not available e.g. since it isn't
     *                                     installed
     */
    @Override
     ...
     *
     * @param message the commit message used for the {@code commit}
     * @return {@code this}
     */
     ...
     *
     * @param mode {@link CleanupMode} to set
     * @return {@code this}
     * @since 6.1
     */
     ...
     *
     * @param strip if {@code true}, default to {@link CleanupMode#STRIP};
     ...
     *
     * @param commentChar the comment character, or {@code null} to use the value from
     *                    the git config
     * @return {@code this}
     * @since 6.1
     */
     ...
     *
     * @param allowEmpty whether it should be allowed to create a commit which has the
     ...
     * with current time.
     *
     * @param committer the committer used for the {@code commit}
     * @return {@code this}
     */
     ...
     *
     * @param name  the name of the committer used for the {@code commit}
     * @param email the email of the committer used for the {@code commit}
     * @return {@code this}
     */
     ...
     *
     * @param author the author used for the {@code commit}
     * @return {@code this}
     */
     ...
     *
     * @param name  the name of the author used for the {@code commit}
     * @param email the email of the author used for the {@code commit}
     * @return {@code this}
     */
     ...
     *
     * @param all whether to auto-stage all files that have been modified and
     *            deleted
     * @return {@code this}
     ...
     * command line.
     *
     * @param amend whether to amend the tip of the current branch
     * @return {@code this}
     */
     ...
     *
     * @param only path to commit (with <code>/</code> as separator)
     * @return {@code this}
     */
     ...
     *
     * @param insertChangeId whether to insert a change id
     * @return {@code this}
     */
     ...
     *
     * @param reflogComment the comment to be written into the reflog or <code>null</code>
     ...
     * </p>
     *
     * @param noVerify Whether this commit should be verified by the pre-commit and
     *                 commit-msg hooks.
     * @return {@code this}
     * @since 3.7
     */
     ...
     * {@code System.out}.
     *
     * @param hookStdOut the output stream for hook scripts executed by this command
     * @return {@code this}
     * @since 3.7
     */
     ...
     * {@code System.err}.
     *
     * @param hookStdErr the error stream for hook scripts executed by this command
     * @return {@code this}
     * @since 5.6
     */
     ...
     *
     * @param hookName   name of the hook to set the output stream for
     * @param hookStdErr the output stream to use for the selected hook
     * @return {@code this}
     * @since 5.6
     */
     ...
     * </p>
     *
     * @param signingKey signing key (maybe <code>null</code>)
     * @return {@code this}
     * @since 5.3
     */
     ...
     *
     * @param sign <code>true</code> to sign, <code>false</code> to not sign and
     ...
     *
     * @param signer to use; if {@code null}, the default signer will be used
     * @return {@code this}
     * @since 5.11
     */
     ...
     *
     * @param config to set; if {@code null}, the config will be loaded from the
     ...
     *
     * @param credentialsProvider the provider to use when querying for credentials (eg., during
     *                            signing)
     * @return {@code this}
     * @since 6.0
     */
