...
public class DescribeCommand extends GitCommand<String> {
     ...
     * @return {@code this}
     * @throws IncorrectObjectTypeException the supplied id is not a commit or an annotated tag.
     * @throws RefNotFoundException         the given rev didn't resolve to any object.
     * @throws IOException                  a pack file or loose object could not be read.
     */
     ...
     *
     * @param all <code>true</code> enables matching any ref found in refs/
     ...
     * or not.
     *
     * @param tags <code>true</code> enables matching lightweight (non-annotated)
     ...
     *
     * @param always <code>true</code> enables falling back to a uniquely
     ...
     *
     * @param abbrev minimum length of the abbreviated string. Must be in the range
