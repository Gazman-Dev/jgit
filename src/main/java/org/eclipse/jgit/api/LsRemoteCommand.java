...
public class LsRemoteCommand extends
     ...
     *
     * @param repo local repository or null for operation without local
     *             repository
     */
     ...
     *
     * @param heads whether to include refs/heads
     * @return {@code this}
     */
     ...
     *
     * @param tags whether to include tags
     * @return {@code this}
     */
     ...
     *
     * @param uploadPack the full path of executable providing the git-upload-pack
     ...
     * @throws org.eclipse.jgit.api.errors.TransportException for errors that occurs during transport
     * @since 3.5
     */
