...
public class FileHeader extends DiffEntry {
     ...
     *
     * @param headerLines buffer holding the diff header for this file
     * @param edits       the edits for this file
     * @param type        the type of patch used to modify this file
     */
     ...
     * Convert the patch script for this file into a string.
     *
     * @param oldCharset hint character set to decode the old lines with.
     * @param newCharset hint character set to decode the new lines with.
     * @return the patch script, as a Unicode string.
     */
     ...
     * Convert the patch script for this file into a string.
     *
     * @param charsetGuess hint which charset is used
     * @return the patch script, as a Unicode string.
     */
     ...
     *
     * @param ptr first character after the "diff --git " or "diff --cc " part.
     * @param end one past the last position to parse.
     ...
     * @param start first position in the buffer to evaluate
     * @param end   last position to consider; usually the end of the buffer (
