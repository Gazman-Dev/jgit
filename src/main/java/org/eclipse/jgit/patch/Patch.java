...
public class Patch {
     ...
     *
     * @param fh the header of the file.
     */
     ...
     *
     * @param is the stream to read the patch data from. The stream is read
     *           until EOF is reached.
     * @throws IOException there was an error reading from the input stream.
     */
     ...
     * @param ptr starting position to parse from.
     * @param end 1 past the last position to end parsing. The total length to
