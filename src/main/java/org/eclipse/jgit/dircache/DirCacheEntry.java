...
public class DirCacheEntry {
     ...
     * @throws IllegalArgumentException If the path starts or ends with "/", or contains "//" either
     ...
     *
     * @param newPath name of the cache entry.
     * @param stage   the stage index of the new entry.
     * @throws IllegalArgumentException If the path starts or ends with "/", or contains "//" either
     *                                  "\0". These sequences are not permitted in a git tree object
     ...
     * Create an empty entry at stage 0.
     *
     * @param newPath name of the cache entry, in the standard encoding.
     * @throws IllegalArgumentException If the path starts or ends with "/", or contains "//" either
     *                                  "\0". These sequences are not permitted in a git tree object
     *                                  or DirCache file.
     */
     ...
     * Create an empty entry at the specified stage.
     *
     * @param path  name of the cache entry, in the standard encoding.
     * @param stage the stage index of the new entry.
     * @throws IllegalArgumentException If the path starts or ends with "/", or contains "//" either
     *                                  "\0". These sequences are not permitted in a git tree object
     *                                  or DirCache file.  Or if {@code stage} is outside of the
     ...
     * time as the index.
     *
     * @param smudge_s  seconds component of the index's last modified time.
     * @param smudge_ns nanoseconds component of the index's last modified time.
     ...
     * time as the index.
     *
     * @param smudge index's last modified time.
     * @return true if extra careful checks should be used.
     * @since 5.1.9
     */
     ...
     *
     * @param assume true to ignore apparent modifications; false to look at last
     ...
     *
     * @param updateNeeded whether this entry must be checked for changes
     */
     ...
     *
     * @param stage to set, in the range [0..3]
     * @throws IllegalArgumentException if the stage is outside the range [0..3]
     * @since 5.10
     */
     ...
     *
     * @param mode the new mode constant.
     ...
     *
     * @param when new cached creation time of the file, in milliseconds.
     */
     ...
     *
     * @param when new cached modification date of the file, in milliseconds.
     ...
     *
     * @param when new cached modification date of the file.
     * @since 5.1.9
     */
     ...
     *
     * @param sz new cached size of the file, as bytes. If the file is larger
     ...
     * Set the cached size (in bytes) of this file.
     *
     * @param sz new cached size of the file, as bytes.
     */
     ...
     *
     * @param id new object identifier for the entry. May be
     ...
     * supporting renaming.
     *
     * @param src the entry to copy ObjectId and meta fields from.
     */
     ...
     *
     * @param src       the entry to copy ObjectId and meta fields from.
     * @param keepStage if true, the stage attribute will not be copied
     */
