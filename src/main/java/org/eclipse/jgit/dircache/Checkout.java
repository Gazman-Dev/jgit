...
public class Checkout {
     ...
     *
     * @param recursive whether to delete such directories recursively
     * @return {@code this}
     */
     ...
     *
     * @param entry   {@link DirCacheEntry} to check out
     * @param gitPath the git path of the entry, if known already; otherwise
     *                {@code null} and it's read from the entry itself
     * @throws IOException if the gitlink cannot be checked out
     */
     ...
     *
     * @param entry    {@link DirCacheEntry} to check out
     * @param metadata {@link CheckoutMetadata} to use for CR/LF handling and
     *                 smudge filtering
     * @param reader   {@link ObjectReader} to use
     * @param gitPath  the git path of the entry, if known already; otherwise
     *                 {@code null} and it's read from the entry itself
     * @throws IOException if the file cannot be checked out
     */
