...
public class DirCacheEditor extends BaseDirCacheEditor {
     ...
     *
     * @param dc   the cache this editor will eventually update.
     * @param ecnt estimated number of entries the editor will have upon
    ...
    public abstract static class PathEdit {
         ...
         *
         * @param entryPath path of the file within the repository.
         */
         ...
         *
         * @param ent entry instance to match path of. Only the path of this
         ...
         *
         * @param ok if true a file can replace a directory, or a directory can
         *           replace a file.
         * @return {@code this}
         * @since 4.2
         */
         ...
         *
         * @param ent the entry being processed. All fields are zeroed out if
    ...
    public static final class DeletePath extends PathEdit {
         ...
         *
         * @param ent entry instance to remove. Only the path of this entry is
    ...
    public static final class DeleteTree extends PathEdit {
         ...
         *
         * @param entryPath path of the subtree within the repository. If the path
