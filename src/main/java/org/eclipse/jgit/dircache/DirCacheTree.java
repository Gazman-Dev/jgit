...
public class DirCacheTree {
     ...
     *
     * @param i index of the child to obtain.
     ...
     *
     * @param cache      the complete cache from DirCache.
     * @param cIdx       first position of <code>cache</code> that is a member of this
     ...
     * @param pathOffset number of bytes of <code>cache[cacheIdx].path</code> that
     *                   matches this tree's path. The value at array position
     *                   <code>cache[cacheIdx].path[pathOff-1]</code> is always '/' if
     *                   <code>pathOff</code> is &gt; 0.
     * @param ow         the writer to use when serializing to the store.
     ...
     *
     * @param cache   the complete cache from DirCache.
     * @param cCnt    number of entries in <code>cache</code> that are valid for
     *                iteration.
     * @param cIdx    first position of <code>cache</code> that is a member of this
     *                tree. The path of <code>cache[cacheIdx].path</code> for the
     *                range <code>[0,pathOff-1)</code> matches the complete path of
     *                this tree, from the root of the repository.
     * @param pathOff number of bytes of <code>cache[cacheIdx].path</code> that
     *                matches this tree's path. The value at array position
     *                <code>cache[cacheIdx].path[pathOff-1]</code> is always '/' if
     *                <code>pathOff</code> is &gt; 0.
     */
