...
public abstract class GitHook<T> implements Callable<T> {
     ...
     *
     * @throws AbortedByHookException If the underlying hook script exited with non-zero.
     ...
     * @param result  The process result of the hook
     * @throws AbortedByHookException When the hook should be aborted
     * @since 5.11
     */
