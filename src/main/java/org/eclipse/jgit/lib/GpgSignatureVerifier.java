...
public interface GpgSignatureVerifier {
     ...
     *
     * @param config        the {@link GpgConfig}
     * @param data          the signature is for
     * @param signatureData the ASCII-armored signature
     * @return a {@link SignatureVerification} describing the outcome
     * @throws IOException           if the signature cannot be parsed
     * @throws JGitInternalException if signature verification fails
     * @since 6.9
     */
