...
public abstract class AnyObjectId implements Comparable<AnyObjectId> {
     ...
     *
     * @param firstObjectId  the first identifier to compare. Must not be null.
     * @param secondObjectId the second identifier to compare. Must not be null.
     ...
     *
     * @param index index of the byte to obtain from the raw form of the ObjectId.
     *              Must be in range [0,
     ...
     *
     * @param other the other id to compare to. May be null.
