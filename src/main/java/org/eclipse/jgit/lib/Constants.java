...
public final class Constants {
     ...
     * @throws RuntimeException this Java virtual machine does not support the required hash
     ...
     *
     * @param id         object id this type string came from; may be null if that is
     *                   not known at the time the parse is occurring.
     * @param typeString string version of the type code.
     * @param endMark    character immediately following the type string. Usually ' '
     *                   (space) or '\n' (line feed).
     * @param offset     position within <code>typeString</code> where the parse
     ...
     * @throws CorruptObjectException there is no valid type identified by <code>typeString</code>.
     */
     ...
     *
     * @param s the string to convert. Must not contain any characters over
     *          127 (outside of 7-bit ASCII).
     * @return a byte array of the same length as the input string, holding the
     * same characters, in the same order.
     * @throws IllegalArgumentException the input string contains one or more characters outside of
     ...
     *
     * @param str the string to convert. May contain any Unicode characters.
