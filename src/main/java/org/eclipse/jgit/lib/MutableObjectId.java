...
public class MutableObjectId extends AnyObjectId {
     ...
     *
     * @param index index of the byte to set in the raw form of the ObjectId. Must
     *              be in range [0,
     *              {@link Constants#OBJECT_ID_LENGTH}).
     * @param value the value of the specified byte at {@code index}. Values are
     *              unsigned and thus are in the range [0,255] rather than the
     *              signed byte range of [-128, 127].
     * @throws ArrayIndexOutOfBoundsException {@code index} is less than 0, equal to
     ...
     *
     * @param ints the raw int buffer to read from. At least 5 integers must be
     ...
     * Convert an ObjectId from binary representation expressed in integers.
     *
     * @param ints the raw int buffer to read from. At least 5 integers after p
