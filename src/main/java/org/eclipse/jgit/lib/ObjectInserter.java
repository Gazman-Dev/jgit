...
public abstract class ObjectInserter implements AutoCloseable {
     ...
     * @param in         stream providing the object content. The caller is responsible
     ...
     *
     * @param formatter a {@link TreeFormatter} object.
     ...
     *
     * @param builder the builder containing the proposed commit's data.
     ...
     *
     * @param objectType type code of the object to store.
     * @param length     number of bytes to copy from {@code in}.
     * @param in         stream providing the object content. The caller is responsible
     *                   for closing the stream.
     * @return the name of the object.
     * @throws IOException the object could not be stored, or the source stream could
     *                     not be read.
     */
     ...
     *
     * @param in the input stream. The stream is not closed by the parser, and
     *           must instead be closed by the caller once parsing is complete.
     * @return the pack parser.
     * @throws IOException the parser instance, which can be configured and then used to
     ...
     * other threads.
     *
     * @throws IOException the flush could not be completed; objects inserted thus far
