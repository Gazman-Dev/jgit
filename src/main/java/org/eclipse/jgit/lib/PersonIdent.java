...
public class PersonIdent implements Serializable {
     ...
     *
     * @param tzOffset timezone offset as in {@link #getTimeZoneOffset()}.
     ...
     *
     * @param r      string builder to append to.
     * @param offset timezone offset as in {@link #getTimeZoneOffset()}.
     * @since 4.1
     */
     ...
     * @param aName         a {@link String} object.
     * @param aEmailAddress a {@link String} object.
     * @param when          a {@link ProposedTimestamp} object.
     * @since 4.6
     */
    public PersonIdent(String aName, String aEmailAddress,
     ...
     *
     * @param pi    original {@link PersonIdent}
     * @param aWhen local time as Instant
     * @since 6.1
     */
