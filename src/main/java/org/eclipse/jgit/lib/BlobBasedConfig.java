...
public class BlobBasedConfig extends Config {
     ...
     * @throws IOException            the blob cannot be read from the repository.
     * @throws ConfigInvalidException the blob is not a valid configuration format.
     */
     ...
     *
     * @param base    the base configuration file
     * @param db      the repository containing the objects.
     * @param treeish the tree (or commit) that contains the object
     * @param path    the path within the tree
     * @throws FileNotFoundException  the path does not exist in the commit's tree.
     * @throws IOException            the tree and/or blob cannot be accessed.
     * @throws ConfigInvalidException the blob is not a valid configuration format.
     */
