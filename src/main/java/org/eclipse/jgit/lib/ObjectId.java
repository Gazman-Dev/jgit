...
public class ObjectId extends AnyObjectId implements Serializable {
     ...
     *
     * @param firstBuffer  the first buffer to compare against. Must have at least 20
     *                     bytes from position fi through the end of the buffer.
     * @param fi           first offset within firstBuffer to begin testing.
     * @param secondBuffer the second buffer to compare against. Must have at least 20
