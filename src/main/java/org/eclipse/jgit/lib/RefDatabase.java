...
public abstract class RefDatabase {
     ...
     * @throws IOException the database could not be read to check for conflicts.
     ...
     *
     * @param name the name of the reference. May be a short name which must be
     ...
     *
     * @param prefix prefix to search the namespace with; must end with {@code /}.
     ...
     *
     * @param prefix string that names of refs should start with; may be empty (to
     *               return all refs).
     ...
     * (or {@code null}).
     * @throws IOException the reference space or object space cannot be accessed.
     */
    @NonNull
     ...
     *
     * @param map  map of refs to search within. Names should be fully qualified,
     *             e.g. "refs/heads/master".
     * @param name short name of ref to find, e.g. "master" to find
