 ...
 *
 * @param <B> type of the repository builder.
 * @param <R> type of the repository that is constructed.
...
public class BaseRepositoryBuilder<B extends BaseRepositoryBuilder, R extends Repository> {
     ...
     *
     * @param objectDirectory {@code GIT_OBJECT_DIRECTORY}, the directory where the
     ...
     *
     * @param other another objects directory to search after the standard one.
     * @return {@code this} (for chaining calls).
     */
     ...
     *
     * @param inList other object directories to search after the standard one. The
     ...
     *
     * @param mustExist true if it must exist; false if it can be missing and created
     *                  after being built.
     * @return {@code this} (for chaining calls).
     */
     ...
     *
     * @param workTree {@code GIT_WORK_TREE}, the working directory of the checkout.
     * @return {@code this} (for chaining calls).
     */
     ...
     *
     * @param indexFile {@code GIT_INDEX_FILE}, the index file location.
     * @return {@code this} (for chaining calls).
     */
     ...
     * master).
     *
     * @param branch initial branch name of the new repository. If {@code null} or
     *               empty the configured default branch will be used.
     * @return {@code this}
     * @throws InvalidRefNameException if the branch name is not valid
     * @since 5.11
     */
     ...
     *
     * @param sr the SystemReader abstraction to access the environment.
     * @return {@code this} (for chaining calls).
     */
     ...
     *
     * @param root a path to stop searching at; its parent will not be searched.
     * @return {@code this} (for chaining calls).
     */
     ...
     *
     * @param inList directory paths to stop searching at. The collection's
     ...
     * to support {@code GIT_CEILING_DIRECTORIES}.
     *
     * @param inList directory paths to stop searching at. The array's contents is
     ...
     * prior call to {@link #readEnvironment()}.
     *
     * @param current directory to begin searching in.
     * @return {@code this} (for chaining calls).
     */
     ...
     *
     * @return {@code this}
     * @throws IllegalArgumentException insufficient parameters were set, or some parameters are
     ...
     *
     * @throws IOException the repository could not be accessed
     */
     ...
     *
     * @throws IOException the repository configuration could not be read.
     */
     ...
     * @throws IOException the configuration is not available, or is badly formed.
     */
