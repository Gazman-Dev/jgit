...
public interface TypedConfigGetter {
     ...
     *
     * @param config       to get the value from
     ...
     * @param defaultValue default value to return if no value was present. Use
     ...
     * </p>
     *
     * @param config         to get the path from.
     * @param section        section the key is in.
     * @param subsection     subsection the key is in, or null if not in a subsection.
     * @param name           the key name.
     ...
     *
     * @param config     to get the list from
     * @param section    section the key is in.
     * @param subsection subsection the key is in, or null if not in a subsection.
     * @param name       the key name.
