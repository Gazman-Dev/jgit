...
public abstract class ObjectBuilder {
     ...
     *
     * @param newAuthor the new author, must be non-{@code null}
     */
     ...
     * </ol>
     *
     * @param gpgSignature the signature to set or {@code null} to unset
     * @since 5.3
     */
     ...
     * </p>
     *
     * @param in           signature string with line breaks
     * @param out          output stream
     * @param enforceAscii whether to throw {@link IllegalArgumentException} if non-ASCII
     *                     characters are encountered
     * @throws IOException              thrown by the output stream
     * @throws IllegalArgumentException if the signature string contains non 7-bit ASCII chars and
