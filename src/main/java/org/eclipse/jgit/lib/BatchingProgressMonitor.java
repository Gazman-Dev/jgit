...
public abstract class BatchingProgressMonitor implements ProgressMonitor {
     ...
     *
     * @param time how long to wait before output. If 0 output begins on the
     ...
     * @param workCurr number of units already completed.
     * @param duration how long this task runs
     * @since 6.5
     */
     ...
     *
     * @param taskName name of the task.
     * @param workCurr total number of units processed.
     * @param duration how long this task runs
     * @since 6.5
     */
     ...
     * @param taskName    name of the task.
     * @param workCurr    number of units already completed.
     * @param workTotal   estimated number of units to process.
     * @param percentDone {@code workCurr * 100 / workTotal}.
     * @param duration    how long this task runs
     * @since 6.5
     */
    protected abstract void onUpdate(String taskName, int workCurr,
     ...
     *
     * @param s        StringBuilder to append the formatted duration to
