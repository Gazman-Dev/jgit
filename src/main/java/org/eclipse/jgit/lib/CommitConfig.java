...
public class CommitConfig {
     ...
     * git config.
     *
     * @param mode         {@link CleanupMode} to resolve
     * @param defaultStrip if {@code true} return {@link CleanupMode#STRIP} if the git
     ...
     *
     * @param repository to resolve relative path in local git repo config
     * @return content of the commit template or {@code null} if not present.
     * @throws IOException            if the template file can not be read
     * @throws FileNotFoundException  if the template file does not exists
     * @throws ConfigInvalidException if a {@code commitEncoding} is specified and is invalid
     * @since 6.0
     */
    @Nullable
     ...
     * @param mode        {@link CleanupMode} to use
     * @param commentChar comment character (normally {@code #}) to use if {@code mode}
     *                    is {@link CleanupMode#STRIP} or {@link CleanupMode#SCISSORS}
     * @return the processed text
     * @throws IllegalArgumentException if {@code mode} is {@link CleanupMode#DEFAULT} (use
     ...
     * returned.
     *
     * @param text to get a comment character for
