...
public abstract class RefRename {
     ...
     *
     * @param src operation to read and delete the source.
     * @param dst operation to create (or overwrite) the destination.
     */
     ...
     *
     * @param msg the message to describe this change.
     */
     ...
     * @throws IOException the current value of {@code HEAD} cannot be read.
     */
