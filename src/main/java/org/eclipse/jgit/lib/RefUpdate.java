...
public abstract class RefUpdate {
     ...
     * @throws IOException the lock couldn't be taken due to an unexpected storage
     ...
     * Do update
     *
     * @param desiredResult a {@link Result} object.
     * @return {@code result}
     ...
     *
     * @param msg          the message to describe this change. It may be null if
     ...
     * @throws IOException an unexpected IO error occurred while writing changes.
     */
     ...
     *
     * @param target name of the new target for this reference. The new target name
