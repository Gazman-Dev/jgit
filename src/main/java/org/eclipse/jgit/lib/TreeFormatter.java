...
public class TreeFormatter {
     ...
     *
     * @param mode    the mode the entry will have.
     * @param nameLen the length of the name, in bytes.
     ...
     *
     * @param size estimated size of the tree, in bytes. Callers can use
     ...
     * @param commit the ObjectId to store in this entry.
     */
     ...
     *
     * @param name name of the entry.
     * @param tree the ObjectId to store in this entry.
     */
     ...
     *
     * @param name name of the entry.
     * @param blob the ObjectId to store in this entry.
     */
     ...
     *
     * @param name name of the entry.
     * @param mode mode describing the treatment of {@code id}.
     * @param id   the ObjectId to store in this entry.
     */
     ...
     * Append any entry to the tree.
     *
     * @param name name of the entry. The name should be UTF-8 encoded, but file
     ...
     * Append any entry to the tree.
     *
     * @param nameBuf buffer holding the name of the entry. The name should be UTF-8
     *                encoded, but file name encoding is not a well defined concept
     *                in Git.
     * @param namePos first position within {@code nameBuf} of the name data.
     * @param nameLen number of bytes from {@code nameBuf} to use as the name.
     * @param mode    mode describing the treatment of {@code id}.
     * @param id      the ObjectId to store in this entry.
     */
     ...
     * @param mode           mode describing the treatment of {@code id}.
     * @param id             the ObjectId to store in this entry.
     * @param allowEmptyName allow an empty filename (creating a corrupt tree)
     * @since 4.6
     */
    public void append(byte[] nameBuf, int namePos, int nameLen, FileMode mode,
     ...
     * @param nameLen number of bytes from {@code nameBuf} to use as the name.
     * @param mode    mode describing the treatment of {@code id}.
     * @param idBuf   buffer holding the raw ObjectId of the entry.
     * @param idPos   first position within {@code idBuf} to copy the id from.
     */
    public void append(byte[] nameBuf, int namePos, int nameLen, FileMode mode,
     ...
     *
     * @param ins the inserter to store the tree.
     ...
     * using {@link ObjectInserter#insert(TreeFormatter)}
     * instead.
     *
