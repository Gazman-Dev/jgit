...
public interface GpgObjectSigner {
     ...
     * </p>
     *
     * @param object              the object to sign (must not be {@code null} and must be
     ...
     *                            passphrase)
     * @param config              GPG settings from the git config
     * @throws CanceledException                 when signing was canceled (eg., user aborted when entering
     *                                           passphrase)
     * @throws UnsupportedSigningFormatException if a config is given and the wanted key format is not
     *                                           supported
     */
