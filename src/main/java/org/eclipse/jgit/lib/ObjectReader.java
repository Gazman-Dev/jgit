...
public abstract class ObjectReader implements AutoCloseable {
     ...
     *
     * @param objectId object identity that needs to be abbreviated.
     * @param len      minimum length of the abbreviated string. Must be in the range
     ...
     *
     * @param id abbreviated id to resolve to a complete identity. The
     ...
     *                 {@link #OBJ_ANY} if the object type is not known, or does not
     *                 matter to the caller.
     * @param size     threshold value for the size of the object in bytes.
     ...
     *
     * @param <T>           type of {@code ObjectId}
     * @param objectIds     objects to get the size of from the object store. The supplied
     ...
     *
     * @param avoid true to avoid unreachable objects.
     * @since 3.0
     */
     ...
     * @throws IOException when the index fails to load
     * @since 3.0
     */
     ...
     *
     * @param rw revwalk for use by the reachability checker
     ...
     *
     * @param ow objectwalk for use by the reachability checker
     ...
     * @throws IOException if it cannot open any of the underlying commit graph.
     * @since 6.5
     */
