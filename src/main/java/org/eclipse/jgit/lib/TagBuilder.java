...
public class TagBuilder extends ObjectBuilder {
     ...
     * @param objType the type of {@code obj}. Must be a valid type code.
     */
     ...
     *
     * @param obj the object the tag will refer to.
     */
     ...
     *
     * @param shortName new short name of the tag. This short name should not start
     ...
     *
     * @param taggerIdent the creator. May be null.
     */
