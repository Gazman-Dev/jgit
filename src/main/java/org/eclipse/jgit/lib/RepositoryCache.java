...
public class RepositoryCache {
     ...
     *
     * @param location where the local repository is. Typically a
     *                 {@link FileKey}.
     * @return the repository instance requested; caller must close when done.
     * @throws IOException                 the repository could not be read (likely its core.version
     *                                     property is not supported).
     * @throws RepositoryNotFoundException there is no repository at the given location.
     */
     ...
     * @param location  where the local repository is. Typically a
     *                  {@link FileKey}.
     * @param mustExist If true, and the repository is not found, throws {@code
     *                  RepositoryNotFoundException}. If false, a repository instance
     *                  is created and registered anyway.
     * @return the repository instance requested; caller must close when done.
     * @throws IOException                 the repository could not be read (likely its core.version
     *                                     property is not supported).
     * @throws RepositoryNotFoundException There is no repository at the given location, only thrown if
     ...
     *
     * @param db repository to register.
     */
     ...
     * close it.
     *
     * @param db repository to unregister.
     */
     ...
     * and close the repository.
     *
     * @param location location of the repository to remove.
     * @since 4.1
     */
    ...
    public static interface Key {
         ...
         *
         * @param mustExist true if the repository must exist in order to be opened;
         ...
         * @throws IOException                 the repository could not be read (likely its core.version
         *                                     property is not supported).
         * @throws RepositoryNotFoundException There is no repository at the given location, only thrown
    ...
    public static class FileKey implements Key {
         ...
         *
         * @param directory location where the repository database is.
         ...
         * </ol>
         *
         * @param directory location where the repository database might be.
         * @param fs        the file system abstraction which will be necessary to
         *                  perform certain file system operations.
         * @return a key for the given directory.
         * @see #exact(File, FS)
         ...
         * and directories.
         *
         * @param dir the location of the directory to examine.
         * @param fs  the file system abstraction which will be necessary to
         *            perform certain file system operations.
         ...
         * </ol>
         *
         * @param directory location to guess from. Several permutations are tried.
         * @param fs        the file system abstraction which will be necessary to
         *                  perform certain file system operations.
