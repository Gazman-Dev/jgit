...
public class ObjectChecker {
     ...
     *
     * @param objects collection of object names known to be broken in a non-fatal
     ...
     *
     * @param ids error types to ignore. The caller's set is copied.
     * @return {@code this}
     * @since 4.2
     */
     ...
     *
     * @param id     error type to ignore.
     * @param ignore true to ignore this error; false to treat the error as an
     *               error and throw.
     * @return {@code this}
     * @since 4.2
     */
     ...
     *
     * @param allow if true accept invalid person identity strings.
     * @return {@code this}.
     * @since 4.0
     */
     ...
     *
     * @param objType type of the object. Must be a valid object type code in
     *                {@link Constants}.
     * @param raw     the raw data which comprises the object. This should be in the
     *                canonical format (that is the format used to generate the
     *                ObjectId of the object). The array is never modified.
     * @throws CorruptObjectException if an error is identified.
     */
     ...
     * Check an object for parsing errors.
     *
     * @param id      identify of the object being checked.
     * @param objType type of the object. Must be a valid object type code in
     *                {@link Constants}.
     * @param raw     the raw data which comprises the object. This should be in the
     *                canonical format (that is the format used to generate the
     ...
     *
     * @param raw the commit data. The array is never modified.
     ...
     *
     * @param raw the tag data. The array is never modified.
     * @throws CorruptObjectException if any error was detected.
     */
     ...
     *
     * @param raw the raw tree data. The array is never modified.
     * @throws CorruptObjectException if any error was detected.
     */
     ...
     * folding.
     *
     * @param buf   byte array to decode
     * @param start position where a supposed filename is starting
     * @param end   position where a supposed filename is ending
     * @param id    object id for error reporting
     ...
     *
     * @param raw the blob data. The array is never modified.
     * @throws CorruptObjectException if any error was detected.
     */
