...
public class CommitBuilder extends ObjectBuilder {
     ...
     *
     * @param newAuthor the new author. Should not be null.
     */
    @Override
     ...
     *
     * @param newCommitter the committer information. Should not be null.
     */
     ...
     *
     * @param parent1 the first parent of this commit. Typically this is the current
     *                value of the {@code HEAD} reference and is thus the current
     *                branch's position in history.
     * @param parent2 the second parent of this merge commit. Usually this is the
     ...
     * Set the parents of this commit.
     *
     * @param newParents the entire list of parents for this commit.
     */
     ...
     *
     * @param encodingName the encoding name. See
