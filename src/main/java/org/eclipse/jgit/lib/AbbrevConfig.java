...
public final class AbbrevConfig {
     ...
     *
     * @param len configured number of hex-digits to abbreviate object ids to
     ...
     * @throws InvalidConfigurationException if value of core.abbrev is invalid
     */
     ...
     *
     * @param repo the repository the AbbrevConfig shall be computed for
     ...
     *
     * @param abbrev abbreviation length
     */
