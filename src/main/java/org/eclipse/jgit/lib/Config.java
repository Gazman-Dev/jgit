...
public class Config {
     ...
     *
     * @param getter to use; if {@code null} use the default getter.
     * @since 4.9
     */
     ...
     *
     * @param <T>          type of the returned enum
     * @param section      section the key is grouped within.
     * @param subsection   subsection name, such a remote or branch name.
     * @param name         name of the key to get.
     * @param defaultValue default value to return if no value was present.
     ...
     * @param subsection     subsection the key is in, or null if not in a subsection.
     * @param name           the key name.
     * @param fs             to use to convert the string into a path.
     * @param resolveAgainst directory to resolve the path against if it is a relative
     *                       path; {@code null} to use the Java process's current
     *                       directory.
     * @param defaultValue   to return if no value was present
     ...
     *
     * @param section   the section
     * @param recursive if {@code true} recursively adds the names defined in all base
     *                  configurations
     * @return the list of names defined for this section
     * @since 3.2
     */
     ...
     *
     * @param <T>    type of configuration model to return.
     * @param parser parser which can create the model if it is not already
     ...
     *
     * @param parser parser used to obtain the configuration object.
     ...
     * </pre>
     *
     * @param <T>        type of the enum to set
     * @param section    section name, e.g "branch"
     * @param subsection optional subsection value, e.g. a branch name
     * @param name       parameter name, e.g. "filemode"
     * @param value      parameter value
     ...
     * @param subsection optional subsection value, e.g. a branch name
     * @param name       parameter name, e.g. "filemode"
     * @param value      parameter value, e.g. "true"
     */
     ...
     * @param subsection optional subsection value, e.g. a branch name
     * @param name       parameter name, e.g. "filemode"
     * @param values     list of zero or more values for this key.
     */
     ...
     *
     * @param relPath possibly relative path to the included config, as specified in
     *                this config
     * @return the read bytes, or null if the included config should be ignored
     * @throws ConfigInvalidException if something went wrong while reading the config
     * @since 4.10
     */
     ...
     *
     * @param bytes the bytes to check encoding for.
     ...
     *
     * @param <T> type of the application model created by the parser.
     */
