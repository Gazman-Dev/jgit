...
public interface BitmapIndex {
     ...
     * commit.
     *
     * @param listener instance listening to lookup events in the index. Never null.
    ...
    public interface BitmapBuilder extends Bitmap {
         ...
         *
         * @param objectId the object ID
         * @param type     the Git object type. See {@link Constants}.
         ...
         *
         * @param bitmapIndex the bitmap index to check if it is completely contained
