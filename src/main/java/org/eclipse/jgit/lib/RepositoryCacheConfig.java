...
public class RepositoryCacheConfig {
     ...
     * the RepositoryCache in milliseconds.
     *
     * @param expireAfterMillis the time an unused repository should be expired and be evicted
     ...
     * milliseconds.
     *
     * @param cleanupDelayMillis the delay between the periodic cleanup of expired repository
     ...
     * unmodified.
     *
     * @param config configuration to read properties from.
     * @return {@code this}.
     */
