...
public class FileModeCache {
     ...
     *
     * @param repo {@link Repository} this cache is for
     */
     ...
     *
     * @param gitPath   of the file to be written
     * @param parentDir directory in which the file shall be placed, assumed to be the
     *                  parent of the {@code gitPath}
     * @param makeSpace whether to delete a possibly existing file at
     *                  {@code parentDir}
     * @throws IOException if the directory cannot be created, if necessary
     */
     ...
     *
     * @param gitPath   of a file to be written
     * @param dir       directory in which the file shall be placed, assumed to be the
     *                  parent of the {@code gitPath}
     * @param makeSpace whether to remove a file that already at that name
     * @return A {@link CacheItem} describing the directory, which is guaranteed
     * to exist
     * @throws IOException if the directory cannot be made to exist at the given
     *                     location
     */
     ...
     * mode is overwritten.
     *
     * @param gitPath   to cache the {@link FileMode} for
     * @param finalMode {@link FileMode} to cache
    ...
    public static class CacheItem {
         ...
         *
         * @param mode {@link FileMode} to cache
         */
         ...
         * @param childMode {@link FileMode} to cache
