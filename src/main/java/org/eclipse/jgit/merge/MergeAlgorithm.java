...
public final class MergeAlgorithm {
     ...
     *
     * @param diff the diff algorithm used by this merge
     */
     ...
     *
     * @param strategy {@link ContentMergeStrategy} to set; if {@code null}, set
     ...
     * END_EDIT.
     *
     * @param it the iterator for which the next edit should be returned
