...
public class MergeResult<S extends Sequence> implements Iterable<MergeChunk> {
     ...
     *
     * @param sequences contains the common predecessor sequence at position 0
     ...
     *
     * @param srcIdx        determines from which sequence this range comes. An index of
     *                      x specifies the x+1 element in the list of sequences
     *                      specified to the constructor
     * @param begin         the first element from the specified sequence which should be
     *                      included in the merge result. Indexes start with 0.
     * @param end           specifies the end of the range to be added. The element this
     ...
     * @param conflictState when set to NO_CONLICT a non-conflicting range is added.
     ...
     *
     * @param containsConflicts whether this merge should be seen as containing a conflict or
     *                          not.
     * @since 3.5
     */
