...
public abstract class Merger {
     ...
     *
     * @param oi the inserter to write objects to. Will be closed at the
     ...
     * @throws NullPointerException if the merger was constructed without a repository.
     * @since 4.8
     */
     ...
     *
     * @param oi the inserter instance to use. Must be associated with the
     ...
     *
     * @param tips source trees to be combined together. The merge base is not
     ...
     * @throws IOException                  one or more sources could not be read, or outputs could not
     ...
     * trees or commits may be passed as input objects.
     *
     * @param flush whether to flush and close the underlying object inserter when
     ...
     *
     * @param a the first commit in {@link #sourceObjects}.
     * @param b the second commit in {@link #sourceObjects}.
     * @return the merge base of two commits
     ...
     *
     * @param treeId the tree to scan; must be a tree (not a treeish).
     * @return an iterator for the tree.
     * @throws IncorrectObjectTypeException the input object is not a tree.
     * @throws IOException                  the tree object is not found or cannot be read.
     */
     ...
     *
     * @param monitor Monitor to use, can be null to indicate no progress reporting
     *                is desired.
     * @since 4.2
     */
