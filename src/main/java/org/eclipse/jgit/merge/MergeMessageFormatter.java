...
public class MergeMessageFormatter {
     ...
     *
     * @param refsToMerge the refs which will be merged
     * @param target      the branch ref which will be merged into
     ...
     * with a hash.
     *
     * @param message          the original merge message
     * @param conflictingPaths the paths with conflicts
     ...
     * @param message          the original merge message
     * @param conflictingPaths the paths with conflicts
     * @param commentChar      comment character to use for prefixing the conflict lines
     * @return merge message with conflicting paths added
     * @since 6.1
     */
    public String formatWithConflicts(String message,
