...
public abstract class MergeStrategy {
     ...
     *
     * @param imp the strategy to register.
     * @throws IllegalArgumentException a strategy by the same name has already been registered.
     */
     ...
     * Register a merge strategy so it can later be obtained by name.
     *
     * @param name name the strategy can be looked up under.
     * @param imp  the strategy to register.
     * @throws IllegalArgumentException a strategy by the same name has already been registered.
     */
     ...
     *
     * @param name name of the strategy to locate.
     ...
     *
     * @param db repository database the merger will read from, and eventually
     ...
     * @param db     repository database the merger will read from, and eventually
     *               write results back to.
     * @param inCore the merge will happen in memory, working folder will not be
     ...
     * will fail.
     *
     * @param inserter inserter to write results back to.
     * @param config   repo config for reading diff algorithm settings.
     * @return the new merge instance which implements this strategy.
     * @since 4.8
     */
