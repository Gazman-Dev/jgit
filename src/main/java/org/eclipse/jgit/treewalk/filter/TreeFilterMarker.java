...
public class TreeFilterMarker {
     ...
     *
     * @param markTreeFilters the filters to use for marking, must not have more elements
     *                        than {@link Integer#SIZE}.
     * @throws IllegalArgumentException if more tree filters are passed than possible
     */
     ...
     * constructor.
     *
     * @param walk the walk from which to test the current entry
     * @return the marks bitmask
     * @throws MissingObjectException       as thrown by
     *                                      {@link TreeFilter#include(TreeWalk)}
     * @throws IncorrectObjectTypeException as thrown by
     *                                      {@link TreeFilter#include(TreeWalk)}
