...
class ByteArraySet {
     ...
     *
     * @param toFind array to find.
     * @param length The number of bytes in toFind that are used
     * @param hash   pre-computed hash of toFind
     ...
     * </pre>
     *
     * @param newValue the array to store by reference if the length is the same as
     *                 the length parameter
     * @param length   The number of bytes in newValue that are used
     * @param hash     pre-computed hash of toFind
