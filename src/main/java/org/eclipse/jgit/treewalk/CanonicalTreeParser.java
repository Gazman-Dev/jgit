...
public class CanonicalTreeParser extends AbstractTreeIterator {
     ...
     * @param reader reader to load the tree data from.
     * @param treeId identity of the tree being parsed; used only in exception
     *               messages if data corruption is found.
     * @throws MissingObjectException       the object supplied is not available from the repository.
     * @throws IncorrectObjectTypeException the object supplied as an argument is not actually a tree and
     ...
     *
     * @param reader reader to use during repository access.
     * @param id     identity of the tree being parsed; used only in exception
     *               messages if data corruption is found.
     ...
     *
     * @param reader reader to load the tree data from.
     * @param id     ObjectId of the tree to open.
     ...
     * current entry.
     *
     * @param reader {@link ObjectReader} used to parse the
     *               .gitattributes entry.
