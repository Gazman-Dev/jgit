...
public class FileTreeIterator extends WorkingTreeIterator {
     ...
     *
     * @param repo             the repository whose working tree will be scanned.
     * @param fileModeStrategy the strategy to use to determine the FileMode for a FileEntry;
     ...
     * @param fs               the file system abstraction which will be necessary to perform
     *                         certain file system operations.
     * @param fileModeStrategy the strategy to use to determine the FileMode for a given
     *                         FileEntry.
     * @since 4.3
     */
    ...
    public interface FileModeStrategy {
         ...
         *
         * @param f          the file to return a FileMode for
         * @param attributes the attributes of a file
    ...
    public static class FileEntry extends Entry {
         ...
         * @param f                file
         * @param fs               file system
         * @param fileModeStrategy the strategy to use when determining the FileMode of a
