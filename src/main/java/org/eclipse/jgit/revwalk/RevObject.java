...
public abstract class RevObject extends ObjectIdOwnerMap.Entry {
     ...
     *
     * @param flag the flag to mark on this object, for later testing.
     */
     ...
     *
     * @param set the set of flags to mark on this object, for later testing.
     */
     ...
     *
     * @param flag the flag to remove from this object.
     */
     ...
     *
     * @param set the flag to remove from this object.
     */
     ...
     *
     * @param s buffer to append a debug description of core RevFlags onto.
     */
