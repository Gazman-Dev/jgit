...
public class RevTag extends RevObject {
     ...
     *
     * @param rw  the revision pool to allocate the tag within. The tag's object
     *            pointer will be obtained from this pool.
     * @param raw the canonical formatted tag to be parsed. This buffer will be
     ...
     *
     * @param id object name for the tag.
     */
