...
public interface ObjectReachabilityChecker {
     ...
     *
     * @param targets  objects to check for reachability from the starters
     * @param starters objects known to be reachable to the caller
     ...
     * @throws IOException Cannot access underlying storage
