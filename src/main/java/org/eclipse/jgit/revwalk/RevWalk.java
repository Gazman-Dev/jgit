...
public class RevWalk implements Iterable<RevCommit>, AutoCloseable {
     ...
     *
     * @param repo the repository the walker will obtain data from. An
     ...
     * Create a new revision walker for a given repository.
     *
     * @param or the reader the walker will obtain data from. The reader is not
     ...
     * @throws IOException if it cannot open any of the underlying indices.
     * @since 5.4
     ...
     *
     * @param c the commit to start traversing from. The commit passed must be
     *          from this same revision walker.
     * @throws MissingObjectException       the commit supplied is not available from the object
     ...
     *
     * @param list commits to start traversing from. The commits passed must be
     *             from this same revision walker.
     * @throws MissingObjectException       one of the commits supplied is not available from the object
     *                                      database. This usually indicates the supplied commit is
     *                                      invalid, but the reference was constructed during an earlier
     *                                      invocation to {@link #lookupCommit(AnyObjectId)}.
     * @throws IncorrectObjectTypeException the object was not parsed yet and it was discovered during
     ...
     *
     * @param base commit the caller thinks is reachable from <code>tip</code>.
     * @param tip  commit to start iteration from, and which is most likely a
     ...
     * @throws MissingObjectException       one or more of the next commit's parents are not available
     *                                      from the object database, but were thought to be candidates
     *                                      for traversal. This usually indicates a broken link.
     * @throws IncorrectObjectTypeException one or more of the next commit's parents are not actually
     *                                      commit objects.
     * @throws IOException                  a pack file or loose object could not be read.
     */
     ...
     *
     * @param commit commit the caller thinks is reachable from <code>refs</code>.
     * @param refs   refs to start iteration from, and which is most likely a
     ...
     *
     * @param sort a sorting strategy to look for.
     ...
     *
     * @param s   a sorting strategy to enable or disable.
     * @param use true if this strategy should be used, false if it should be
     *            removed.
     */
     ...
     *
     * @param newFilter the new filter. If null the special
     ...
     * instances.
     *
     * @param newFilter new filter. If null the special
     ...
     *
     * @param rewrite whether to rewrite parents; defaults to true.
     * @since 3.4
     */
     ...
     * <p>
     * True by default on {@link RevWalk} and false by
     ...
     *
     * @param enable true to walk only first-parent links.
     * @since 5.5
     */
     ...
     *
     * @param id name of the blob object.
     ...
     * from this method's return value.
     *
     * @param id name of the tree object.
     ...
     *
     * @param id       name of the commit object.
     * @param graphPos the position in the commit-graph of the object.
     * @return reference to the commit object. Never null.
     * @since 6.5
     */
    @NonNull
     ...
     * from this method's return value.
     *
     * @param id name of the tag object.
     ...
     * @param type type of the object. Must be a valid Git object type.
     ...
     *
     * @param id name of the tree object, or a commit or annotated tag that may
     *           reference a tree.
     * @return reference to the tree object. Never null.
     * @throws MissingObjectException       the supplied tree does not exist.
     * @throws IncorrectObjectTypeException the supplied id is not a tree, a commit or an annotated tag.
     * @throws IOException                  a pack file or loose object could not be read.
     */
    @NonNull
     ...
     * @param id name of the tag object.
     * @return reference to the tag object. Never null.
     * @throws MissingObjectException       the supplied tag does not exist.
     * @throws IncorrectObjectTypeException the supplied id is not a tag or an annotated tag.
     * @throws IOException                  a pack file or loose object could not be read.
     */
    @NonNull
     ...
     * @param id name of the object.
     * @return reference to the object. Never null.
     * @throws MissingObjectException the supplied does not exist.
     * @throws IOException            a pack file or loose object could not be read.
     */
    @NonNull
     ...
     *
     * @param <T>           Type of returned {@code ObjectId}
     * @param objectIds     objects to open from the object store. The supplied collection
     *                      must not be modified until the queue has finished.
     * @param reportMissing if true missing objects are reported by calling failure with a
     ...
     * without error.
     *
     * @param obj the object the caller needs to be parsed.
     * @throws MissingObjectException the supplied does not exist.
     * @throws IOException            a pack file or loose object could not be read.
     */
     ...
     * @throws MissingObjectException a referenced object cannot be found.
     * @throws IOException            a pack file or loose object could not be read.
     */
     ...
     *
     * @param name description of the flag, primarily useful for debugging.
     * @return newly constructed flag instance.
     * @throws IllegalArgumentException too many flags have been reserved on this revision walker.
     */
     ...
     *
     * @param flag the flag to carry onto parents, if set on a descendant.
     */
     ...
     * child commit is popped from the lowest level of walk's internal graph.
     *
     * @param set the flags to carry onto parents, if set on a descendant.
     */
     ...
     * {@code #dispose()}.
     *
     * @param flag the flag to retain during all resets.
     * @since 3.6
     */
     ...
     * {@code #dispose()}.
     *
     * @param flags the flags to retain during all resets.
     * @since 3.6
     */
     ...
     * are removed from all RevObjects.
     *
     * @param retainFlags application flags that should <b>not</b> be cleared from
     ...
     *
     * @param id the object this walker requires a commit reference for.
     ...
     *
     * @param ids commits that should be treated as shallow commits, in addition
     ...
     *
     * @param rc the initial commit being parsed
     * @throws IOException if the shallow commits file can't be read
     */
