...
public class TreeRevFilter extends RevFilter {
     ...
     * {@link TreeFilter}.
     *
     * @param walker walker used for reading trees.
     * @param t      filter to compare against any changed paths in each commit. If
     ...
     * @param rewriteFlag flag to color commits to be removed from the simplified DAT.
