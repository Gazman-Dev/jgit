...
public interface ReachabilityChecker {
     ...
     *
     * @param targets  commits to reach.
     * @param starters known starting points.
     ...
     * the starters.
     * @throws MissingObjectException       if any of the incoming objects doesn't exist in the
     *                                      repository.
     * @throws IncorrectObjectTypeException if any of the incoming objects is not a commit or a tag.
     * @throws IOException                  if any of the underlying indexes or readers can not be
     *                                      opened.
