...
public final class RevWalkUtils {
     ...
     *
     * @param walk  the rev walk to use
     * @param start the commit to start counting from
     * @param end   the commit where counting should end, or null if counting
     ...
     *
     * @param commit  the commit we are looking at
     * @param revWalk The RevWalk to be used.
     * @param refs    the set of branches we want to see reachability from
