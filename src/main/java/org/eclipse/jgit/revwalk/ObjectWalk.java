...
public class ObjectWalk extends RevWalk {
    ...
    public interface VisitationPolicy {
         ...
         *
         * @param o the object to check if it should be visited
         ...
         *
         * @param o the object that was visited
         */
     ...
     * Create a new revision and object walker for a given repository.
     *
     * @param or the reader the walker will obtain data from. The reader should
     ...
     *
     * @param policy the {@code VisitationPolicy} to use
     * @since 5.4
     */
     ...
     * @throws MissingObjectException       one or more of the next objects are not available from the
     *                                      object database, but were thought to be candidates for
     *                                      traversal. This usually indicates a broken link.
     * @throws IncorrectObjectTypeException one or more of the objects in a tree do not match the type
     *                                      indicated.
     * @throws IOException                  a pack file or loose object could not be read.
     */
