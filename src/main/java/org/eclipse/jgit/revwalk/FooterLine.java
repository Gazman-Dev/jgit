...
public final class FooterLine {
     ...
     *
     * @param str the message to extract footers from.
     ...
     * Extract the footer lines from the given message.
     *
     * @param raw the raw message to extract footers from.
     * @return ordered list of footer lines; empty list if no footers found.
     * @see RevCommit#getFooterLines()
     * @since 6.7
     */
     ...
     *
     * @param footers list of footers to find the values in.
     ...
     * Whether keys match
     *
     * @param key key to test this line's key name against.
