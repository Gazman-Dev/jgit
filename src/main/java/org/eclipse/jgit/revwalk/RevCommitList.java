 ...
 *
 * @param <E> type of subclass of RevCommit the list is storing.
 */
public class RevCommitList<E extends RevCommit> extends RevObjectList<E> {
     ...
     *
     * @param matching the filter to test commits with. If the filter includes a
     *                 commit it will have the flag set; if the filter does not
     *                 include the commit the flag will be unset.
     * @param flag     the flag to apply (or remove). Applications are responsible
     *                 for allocating this flag from the source RevWalk.
     * @throws IOException                  revision filter needed to read additional objects, but an
     *                                      error occurred while reading the pack files or loose objects
     *                                      of the repository.
     * @throws IncorrectObjectTypeException revision filter needed to read additional objects, but an
     *                                      object was not of the correct type. Repository corruption may
     *                                      have occurred.
     * @throws MissingObjectException       revision filter needed to read additional objects, but an
     ...
     * @param flag       the flag to apply (or remove). Applications are responsible
     *                   for allocating this flag from the source RevWalk.
     * @param rangeBegin first commit within the list to begin testing at, inclusive.
     *                   Must not be negative, but may be beyond the end of the list.
     * @param rangeEnd   last commit within the list to end testing at, exclusive. If
     ...
     *
     * @param flag the flag to remove. Applications are responsible for
     ...
     *
     * @param flag  the flag to test commits against.
     * @param begin first commit index to test at. Applications may wish to begin
     ...
     *
     * @param w the walker to populate from.
     * @see #fillTo(int)
     */
     ...
     *
     * @param highMark number of commits the caller wants this list to contain when
     ...
     *
     * @param commitToLoad commit the caller wants this list to contain when the fill
     *                     operation is complete.
     * @param highMark     maximum number of commits the caller wants this list to
     ...
     *
     * @param index the list position this object will appear at.
     * @param e     the object being added (or set) into the list.
     */
