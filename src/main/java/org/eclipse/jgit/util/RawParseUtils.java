...
public final class RawParseUtils {
     ...
     * @param o     one offset past the location where writing will begin; writing
     ...
     * @param ptrResult optional location to return the new ptr value through. If null
     ...
     * nybble first.
     *
     * @param bs buffer to parse digits from; positions {@code [p, p+4)} will
     *           be parsed.
     * @param p  first position within the buffer to parse.
     * @return the integer value.
     * @throws ArrayIndexOutOfBoundsException if the string is not hex formatted.
     */
     ...
     * nybble first.
     *
     * @param bs buffer to parse digits from; positions {@code [p, p+8)} will
     *           be parsed.
     * @param p  first position within the buffer to parse.
     * @return the integer value.
     * @throws ArrayIndexOutOfBoundsException if the string is not hex formatted.
     ...
     * nibble first.
     *
     * @param bs buffer to parse digits from; positions {@code [p, p+16)} will
     *           be parsed.
     * @param p  first position within the buffer to parse.
     * @return the integer value.
     * @throws ArrayIndexOutOfBoundsException if the string is not hex formatted.
     ...
     * @throws ArrayIndexOutOfBoundsException if the input digit is not a valid hex digit.
     */
     ...
     *
     * @param b   buffer to scan.
     * @param ptr position within buffer to start looking for the next line.
     ...
     *
     * @param b     buffer to extract the header from
     * @param start of the header value, see
     *              {@link #headerStart(byte[], byte[], int)}
     * @param end   of the header; see
     ...
     *
     * @param b   buffer to scan.
     * @param ptr position within buffer to start looking for the header
     *            (normally a new-line).
     ...
     *
     * @param b          buffer to scan.
     * @param headerName header to search for
     * @param ptr        position within buffer to start looking for header at.
     ...
     * @param end 1 past the end of the content within <code>buf</code>.
     * @return a line map indicating the starting position of each line.
     * @throws BinaryBlobException if a NUL byte or a lone CR is found.
     * @since 5.0
     */
     ...
     *
     * @param b   buffer to scan.
     * @param ptr position in buffer to start the scan at. Most callers should
     ...
     * @throws IllegalCharsetNameException if the character set requested by the encoding header is
     *                                     malformed and unsupportable.
     * @throws UnsupportedCharsetException if the JRE does not support the character set requested by
     *                                     the encoding header.
     */
     ...
     *
     * @param in the string to parse a name from.
     ...
     *
     * @param raw   the buffer to parse character data from.
     * @param nameB first position of the identity information. This should be the
     ...
     * @param ptr first position within raw to consider as a footer line key.
     ...
     * @param end    one position past the last location within the buffer to take
     *               data from.
     * @return a string representation of the range <code>[start,end)</code>,
     * after decoding the region through the specified character set.
     */
     ...
     *
     * @param b     buffer to scan.
     * @param start position in buffer to start the scan at. Most callers will
