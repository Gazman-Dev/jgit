...
public final class Base85 {
     ...
     * @param expectedSize of the result
     * @return the decoded bytes
     * @throws IllegalArgumentException if expectedSize doesn't match, the encoded data has a length
     ...
     * @param expectedSize of the result
     * @return the decoded bytes
     * @throws IllegalArgumentException if expectedSize doesn't match, {@code length} is not a
