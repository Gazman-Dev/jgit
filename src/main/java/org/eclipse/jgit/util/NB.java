...
public final class NB {
     ...
     *
     * @param intbuf buffer to acquire the 2 bytes of data from.
     * @param offset position within the buffer to begin reading from. This
     ...
     *
     * @param intbuf buffer to acquire the 3 bytes of data from.
     * @param offset position within the buffer to begin reading from. This
     ...
     *
     * @param intbuf buffer to acquire the 4 bytes of data from.
     * @param offset position within the buffer to begin reading from. This
     ...
     *
     * @param intbuf buffer to acquire the 8 bytes of data from.
     * @param offset position within the buffer to begin reading from. This
     ...
     *
     * @param intbuf buffer to write the 2 bytes of data into.
     * @param offset position within the buffer to begin writing to. This position
     ...
     *
     * @param intbuf buffer to write the 3 bytes of data into.
     * @param offset position within the buffer to begin writing to. This position
     ...
     *
     * @param intbuf buffer to write the 8 bytes of data into.
     * @param offset position within the buffer to begin writing to. This position
