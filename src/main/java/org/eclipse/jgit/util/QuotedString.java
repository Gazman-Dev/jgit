...
public abstract class QuotedString {
     ...
     *
     * @param in any non-null Unicode string.
     ...
     *
     * @param in a Unicode string to remove quoting from.
     ...
     * {@link #quote(String)}.
     *
     * @param in     the input buffer to parse.
     * @param offset first position within <code>in</code> to scan.
     * @param end    one position past in <code>in</code> to scan.
     * @return the cleaned string.
     */
