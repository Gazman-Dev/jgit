...
public abstract class SHA1 {
     ...
     *
     * @param in  input array of bytes.
     * @param p   offset to start at from {@code in}.
     ...
     * @throws Sha1CollisionException if a collision was detected and safeHash is false.
     */
     ...
     * Once {@code digest()} is called, this instance should be discarded.
     *
     * @param id destination to copy the digest to.
     * @throws Sha1CollisionException if a collision was detected and safeHash is false.
     */
