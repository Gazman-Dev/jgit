...
public final class StringUtils {
     ...
     * they otherwise would have a lowercase character equivalent.
     *
     * @param in the input string. Must not be null.
     ...
     * @throws IllegalArgumentException if {@code stringValue} is not recognized as one of the standard
     *                                  boolean names.
     */
     ...
     *
     * @param parts         Strings to join
     * @param separator     separator used to join all but the two last elements
     * @param lastSeparator separator to use for joining the last two elements
     * @return a String with all the joined parts
     */
    public static String join(Collection<String> parts, String separator,
     ...
     *
     * @param in A string with line breaks
     ...
     * @throws NumberFormatException           if the {@code value} is not parseable, or beyond the range of
     *                                         {@link Long}
     * @throws StringIndexOutOfBoundsException if the string is empty or contains only whitespace, or
     ...
     *
     * @param strings Strings to consider
