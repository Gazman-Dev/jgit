...
public class IntList {
     ...
     *
     * @param capacity number of entries the list can initially hold.
     */
     ...
     *
     * @param i index to read, must be in the range [0, {@link #size()}).
     * @return the number at the specified index
     * @throws ArrayIndexOutOfBoundsException the index outside the valid range
     */
     ...
     *
     * @param index index to set, must be in the range [0, {@link #size()}).
     * @param n     value to store at the position.
     */
     ...
     *
     * @param toIndex index position to stop filling at. 0 inserts no filler. 1
     *                ensures the list has a size of 1, adding <code>val</code> if
     *                the list is currently empty.
     * @param val     value to insert into padded positions.
     */
     ...
     *
     * @param comparator provides the comparison values for sorting the entries
     * @since 6.6
     */
     ...
     *
     * @param begin      the index to begin partitioning at, inclusive
     * @param end        the index to end partitioning at, inclusive
     * @param comparator provides the comparison values for sorting the entries
     */
