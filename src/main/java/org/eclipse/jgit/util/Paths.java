...
public final class Paths {
     ...
     *
     * @param path input path to potentially remove trailing {@code '/'} from.
     ...
     * is also empty.
     *
     * @param folder a git path for a directory, without trailing slash
     ...
     *
     * @param aPath first path buffer. The range {@code [aPos, aEnd)} is used.
     * @param aPos  index into {@code aPath} where the first path starts.
     * @param aEnd  1 past last index of {@code aPath}.
     * @param aMode mode of the first file. Trees are sorted as though
     *              {@code aPath[aEnd] == '/'}, even if aEnd does not exist.
     * @param bPath second path buffer. The range {@code [bPos, bEnd)} is used.
     * @param bPos  index into {@code bPath} where the second path starts.
     * @param bEnd  1 past last index of {@code bPath}.
     * @param bMode mode of the second file. Trees are sorted as though
