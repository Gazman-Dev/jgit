...
public class ChangeIdUtil {
     ...
     * Compute a Change-Id.
     *
     * @param treeId        The id of the tree that would be committed
     * @param firstParentId parent id of previous commit or null
     * @param author        the {@link PersonIdent} for the presumed
     *                      author and time
     * @param committer     the {@link PersonIdent} for the presumed
     *                      committer and time
     ...
     *
     * @param message   a message.
     * @param delimiter the line delimiter, like "\n" or "\r\n", needed to find the
     *                  footer
     ...
     *
     * @param lines the commit message split into lines and the line delimiters
     *              stripped off
