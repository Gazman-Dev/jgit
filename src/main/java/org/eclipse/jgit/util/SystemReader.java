...
public abstract class SystemReader {
     ...
     *
     * @param newReader the new instance to use when accessing properties, or null for
     ...
     *
     * @param parent a config with values not found directly in the returned config
     ...
     *
     * @param parent a config with values not found directly in the returned
     ...
     *
     * @return the git configuration found in the user home
     * @throws ConfigInvalidException if configuration is invalid
     * @throws IOException            if something went wrong when reading files
     * @since 5.1.9
     */
     ...
     *
     * @param config configuration to reload if outdated
     * @throws ConfigInvalidException if configuration is invalid
     * @throws IOException            if something went wrong when reading files
     */
     ...
     *
     * @param pattern the pattern as defined in
     ...
     * @param pattern the pattern as defined in
     *                {@link SimpleDateFormat#SimpleDateFormat(String)}
     * @param locale  locale to be used for the {@code SimpleDateFormat}
     * @return the simple date format
     * @since 3.2
     */
     ...
     *
     * @param dateStyle the date style as specified in
     *                  {@link DateFormat#getDateTimeInstance(int, int)}
     * @param timeStyle the time style as specified in
     *                  {@link DateFormat#getDateTimeInstance(int, int)}
