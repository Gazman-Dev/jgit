...
public class RawCharUtil {
     ...
     *
     * @param c the 8-bit US-ASCII encoded character
     ...
     *
     * @param raw   the byte array containing the portion to trim whitespace for
     * @param start the start of the section of bytes
     * @param end   the end of the section of bytes
