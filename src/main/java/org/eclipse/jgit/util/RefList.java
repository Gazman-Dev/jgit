 ...
 *
 * @param <T> the type of reference being stored in the collection.
 */
public class RefList<T extends Ref> implements Iterable<Ref> {
     ...
     *
     * @param <T> type of reference being stored.
     ...
     *
     * @param name name of the reference to find.
     ...
     *
     * @param idx the index to obtain. Must be {@code 0 <= idx < size()}.
     ...
     * @param ref the new value, must not be null.
     ...
     *
     * @param idx position to add the item at. If negative the method assumes it
     *            was a direct return value from {@link #find(String)} and will
     *            adjust it to the correct position.
     * @param ref the new reference to insert.
     ...
     * copies the entire list, it runs in O(N) time.
     *
     * @param idx position to remove the item from.
     ...
     *
     * @param <T>           type of reference being stored.
     * @param mergeFunction if specified the result will be sorted and deduped.
    ...
    public static class Builder<T extends Ref> {
         ...
         *
         * @param capacity the new capacity; if zero or negative, behavior is the same as
         *                 {@link #Builder()}.
         */
         ...
         * @param off position within {@code src} to start copying from.
         * @param cnt number of items to copy from {@code src}.
         */
         ...
         *
         * @param idx index, must have already been added previously.
         ...
         *
         * @param mergeFunction function used for de-duplication
         */
        @SuppressWarnings("unchecked")
