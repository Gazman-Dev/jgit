...
public class BlockList<T> extends AbstractList<T> {
     ...
     *
     * @param capacity number of elements expected to be in the list.
     */
     ...
     *
     * @param src the list to copy elements from.
     */
     ...
     * @param srcIdx first index to copy.
     * @param srcCnt number of elements to copy.
     */
