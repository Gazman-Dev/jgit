...
public class LfsFactory {
     ...
     *
     * @param instance register a {@link LfsFactory} instance as the
     ...
     * @param length    the expected input stream length
     * @param attribute the attribute used to check for LFS enablement (i.e. "merge",
     ...
     *
     * @param db        the repository
     * @param loader    the loader for the blob
     * @param attribute the attribute used to check for LFS enablement (i.e. "merge",
     *                  "diff", "filter" from .gitattributes).
     ...
     *
     * @param repo         the {@link Repository} the hook is applied to.
     ...
     *
     * @param db the repository to check
     ...
     *
     * @param db   the repository
     * @param path the path to find attributes for
    ...
    public static final class LfsInputStream extends InputStream {
         ...
         *
         * @param stream the stream to wrap. the stream will be closed on
         *               {@link #close()}.
         ...
         *
         * @param buffer the buffer to initialize stream and length from. The
         *               buffer will be destroyed on {@link #close()}
         * @throws IOException in case of an error opening the stream to the buffer.
         */
    ...
    public interface LfsInstallCommand extends Callable<Void> {
         ...
         *
         * @param repo the repository to enable support for.
