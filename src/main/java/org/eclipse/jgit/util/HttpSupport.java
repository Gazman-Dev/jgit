...
public class HttpSupport {
     ...
     * @param key    value which must be encoded to protected special characters.
     */
     ...
     * @param keepPathSlash Whether or not to keep "/" in the URL (i.e. don't translate
     *                      them to "%2F").
     ...
     * @throws IOException communications error prevented obtaining the header.
     * @since 4.7
     */
     ...
     *
     * @param proxySelector proxy support for the caller.
     * @param u             location of the server caller wants to talk to.
     * @return proxy to communicate with the supplied URL.
     * @throws ConnectException the proxy could not be computed as the supplied URL could not
     ...
     *
     * @param conn a {@link HttpConnection}
     *             object.
