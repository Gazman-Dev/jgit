...
public abstract class ProposedTimestamp implements AutoCloseable {
     ...
     *
     * @param times   timestamps to wait on.
     * @param maxWait how long to wait for the timestamps.
     * @throws InterruptedException current thread was interrupted before the waiting process
     *                              completed normally.
     * @throws TimeoutException     the timeout was reached without the proposed timestamp become
     ...
     *
     * @param unit what unit to return the timestamp in. The timestamp will be
     ...
     * {@link MonotonicClock} instance will not
     * create an earlier timestamp.
     *
     * @param maxWait how long the implementation may block the caller.
     * @throws InterruptedException current thread was interrupted before the waiting process
     *                              completed normally.
     * @throws TimeoutException     the timeout was reached without the proposed timestamp
