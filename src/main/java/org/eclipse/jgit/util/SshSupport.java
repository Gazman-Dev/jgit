...
public class SshSupport {
     ...
     * output.
     *
     * @param sshUri   the SSH remote URI
     * @param provider the {@link CredentialsProvider} or <code>null</code>.
     * @param fs       the {@link FS} implementation passed to
     *                 {@link SshSessionFactory}
     * @param command  the remote command to execute.
     * @param timeout  a timeout in seconds. The timeout may be exceeded in corner
     *                 cases.
     * @return The entire output read from stdout.
     * @throws IOException            if an IO error occurred
     * @throws CommandFailedException if the ssh command execution failed, error message contains
