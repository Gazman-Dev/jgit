...
public abstract class CachedAuthenticator extends Authenticator {
     ...
     *
     * @param ca the information we should remember.
     */
    ...
    public static class CachedAuthentication {
         ...
         *
         * @param aHost system this is for.
         * @param aPort port number of the service.
         * @param aUser username at the service.
         * @param aPass password at the service.
         */
