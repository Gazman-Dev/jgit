...
public final class EolStreamTypeUtil {
     ...
     * @param options are the {@link org.eclipse.jgit.lib.Config} options with key
     *                {@link WorkingTreeOptions#KEY}
     * @param attrs   are the {@link Attributes} of the
     *                file for which the
     ...
     * @param conversion to be performed
     ...
     * @param in          original stream
     * @param conversion  to be performed
     * @param forCheckout whether the stream is for checking out from the repository
     * @return the converted stream depending on
     * {@link EolStreamType}
     * @since 5.9
     */
