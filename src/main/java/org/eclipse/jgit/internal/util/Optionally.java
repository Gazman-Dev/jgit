 ...
 *
 * @param <T> type of the mutable optional object
 * @since 6.7
 */
public interface Optionally<T> {
    ...
    public class Hard<T> implements Optionally<T> {
        ...
        /**
         * @param element the mutable optional object
         */
    ...
    public class Soft<T> extends SoftReference<T> implements Optionally<T> {
        /**
         * @param t the mutable optional object
         */
        public Soft(T t) {
            super(t);
        }
     ...
     *
     * @param <T> type of the empty Optionally
