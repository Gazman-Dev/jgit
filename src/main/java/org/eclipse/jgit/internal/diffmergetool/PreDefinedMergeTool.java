...
public class PreDefinedMergeTool extends UserDefinedMergeTool {
     ...
     * @param name                  the name
     * @param path                  the path
     * @param parametersWithBase    the tool parameters that are used together with path as
     *                              command and "base is present" ($BASE)
     * @param parametersWithoutBase the tool parameters that are used together with path as
     *                              command and "base is present" ($BASE)
     ...
     * Creates the pre-defined merge tool
     *
     * @param tool the command line merge tool
     */
    ...
    /**
     * @param withBase get command with base present (true) or without base present
     *                 (false)
