...
public class ExternalToolUtils {
     ...
     * @param localFile  the local file (ours)
     * @param remoteFile the remote file (theirs)
     * @param mergedFile the merged file (worktree)
     ...
     *
     * @param defaultName      the default tool name
     * @param userDefinedNames the user defined tool names
     * @param preDefinedNames  the pre defined tool names
     ...
     *
     * @param repository target repository to traverse into
     * @param path       path to the node in repository to parse git attributes for
     * @param toolKey    config key name for the tool
