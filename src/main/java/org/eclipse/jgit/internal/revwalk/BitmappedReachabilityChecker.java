...
public class BitmappedReachabilityChecker implements ReachabilityChecker {
    ...
    /**
     * @param walk walk on the repository to get or create the bitmaps for the
     *             commits. It must have bitmaps.
     * @throws AssertionError runtime exception if walk is over a repository without
     *                        bitmaps
     * @throws IOException    if the index or the object reader cannot be opened.
     */
    ...
    private static class ReachedFilter extends RevFilter {
         ...
         *
         * @param repoBitmaps bitmap index of the repo
         */
