...
public class DfsPackCompactor {
     ...
     *
     * @param cfg configuration to write a reftable. Reftable compacting is
     ...
     *
     * @param pack a pack to combine into the resulting pack.
     * @return {@code this}
     */
     ...
     *
     * @param table a reftable to combine.
     * @return {@code this}
     */
     ...
     *
     * @return {@code this}
     * @throws IOException existing packs cannot be read.
     */
     ...
     *
     * @param set objects to not include.
     * @return {@code this}.
     */
     ...
     * Exclude objects from the compacted pack.
     *
     * @param pack objects to not include.
     * @return {@code this}.
     * @throws IOException pack index cannot be loaded.
     */
     ...
     * @throws IOException the packs cannot be compacted.
     */
    ...
    private List<ObjectIdWithOffset> toInclude(DfsPackFile src, DfsReader ctx)
        ...
        SCAN:
        for (PackIndex.MutableEntry ent : srcIdx) {
