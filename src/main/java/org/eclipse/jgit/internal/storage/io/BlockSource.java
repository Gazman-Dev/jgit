...
public abstract class BlockSource implements AutoCloseable {
     ...
     *
     * @param in the file. The {@code BlockSource} will close {@code in}.
     ...
     * file channel to read a block.
     *
     * @param ch the file. The {@code BlockSource} will close {@code ch}.
     ...
     *
     * @param position  position of the block in the file, specified in bytes from the
     *                  beginning of the file.
     * @param blockSize size to read.
     ...
     * @throws IOException if size cannot be obtained.
     */
