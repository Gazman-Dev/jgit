...
public abstract class PackBitmapIndex {
     ...
     *
     * @param idxFile      existing pack .bitmap to read.
     * @param packIndex    the pack index for the corresponding pack file.
     * @param reverseIndex the pack reverse index for the corresponding pack file.
     * @return a copy of the index in-memory.
     * @throws IOException            the stream cannot be read.
     * @throws CorruptObjectException the stream does not contain a valid pack bitmap index.
     */
     ...
     * caller. The file may or may not be held open by the returned instance.
     *
     * @param fd           stream to read the bitmap index file from. The stream must be
     ...
     *                             buffered as some small IOs are performed against the stream.
     *                             The caller is responsible for closing the stream.
     * @param packIndexSupplier    the supplier for pack index for the corresponding pack file.
     * @param reverseIndexSupplier the supplier for pack reverse index for the corresponding pack
     *                             file.
     * @param loadParallelRevIndex whether reverse index should be loaded in parallel
     * @return a copy of the index in-memory.
     * @throws IOException            the stream cannot be read.
     * @throws CorruptObjectException the stream does not contain a valid pack bitmap index.
     */
     ...
     *
     * @param objectId the id for which the bitmap position will be found.
     ...
     *
     * @param position the id for which the object will be found.
     * @return the ObjectId.
     ...
     * type.
     *
     * @param bitmap the object bitmap.
     * @param type   the Git type.
     ...
     *
     * @param objectId the id for which the bitmap will be found.
