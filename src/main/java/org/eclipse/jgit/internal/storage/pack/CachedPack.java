...
public abstract class CachedPack {
     ...
     * @throws IOException if the object count cannot be read.
     */
     ...
     * no deltas.
     * @throws IOException if the delta count cannot be read.
     */
     ...
     *
     * @param obj the object being packed. Can be used as an ObjectId.
     * @param rep representation from the
