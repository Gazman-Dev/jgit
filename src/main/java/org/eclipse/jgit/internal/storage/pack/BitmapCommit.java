...
public final class BitmapCommit extends ObjectId {
     ...
     *
     * @param objId the object id of the BitmapCommit
     ...
     * {@code commit}.
     *
     * @param commit the bitmap commit the builder is copying from
    ...
    public static class Builder {
         ...
         *
         * @param objectId the object id of the BitmapCommit
         ...
         *
         * @param reuseWalker whether the BitmapCommit should reuse bitmap walker when
         *                    walking objects
         * @return the builder itself
         */
         ...
         *
         * @param flags the flags of the BitmapCommit
         * @return the builder itself
         */
         ...
         *
         * @param addToIndex whether the bitmap of the BitmapCommit should be added to
         *                   PackBitmapIndexBuilder when building bitmap index file
         * @return the builder itself
         */
