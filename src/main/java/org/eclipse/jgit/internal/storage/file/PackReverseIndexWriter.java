...
public abstract class PackReverseIndexWriter {
     ...
     *
     * @param dst     the OutputStream that contents will be written to
     * @param version the reverse index format version to write contents as
     * @return the new writer instance
     */
    public static PackReverseIndexWriter createWriter(OutputStream dst,
                                                      int version) {
     ...
     *
     * @param objectsByIndexPos the objects whose forward index file positions should be
     *                          written, sorted by forward index file position (currently SHA1
     *                          ordering)
     * @param packChecksum      the checksum of the corresponding pack file
     ...
     * offsets.
     *
     * @param objectsSortedByIndexPosition the objects whose forward index file positions should be
