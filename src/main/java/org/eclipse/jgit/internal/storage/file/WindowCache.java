...
/**
 * Caches slices of a {@link Pack} in
...
public class WindowCache {
    ...
    static interface StatsRecorder {
         ...
         *
         * @param count number of cache hits to record
         */
         ...
         * to be loaded.
         *
         * @param count number of cache misses to record
         */
         ...
         *
         * @param count number of evictions to record
         */
         ...
         *
         * @param delta delta of number of files opened by cache
         */
         ...
         * Record cached bytes
         *
         * @param pack  pack file the bytes are read from
         * @param delta delta of cached bytes
         */
     ...
     *
     * @param cfg the new window cache configuration.
     * @throws IllegalArgumentException the cache configuration contains one or more invalid
     ...
     *
     * @param pack     the pack that "contains" the cached object.
     * @param position offset within <code>pack</code> of the object.
     * @return the object reference.
     * @throws IOException the object reference was not in the cache and could not be
     ...
     *
     * @param pack the file to purge all entries of.
     */
    ...
    private static interface PageRef<T> {
        ...
        /**
         * Get the {@link Pack} the
         * referenced cache page is allocated for
         *
         * @return the {@link Pack} the
         * referenced cache page is allocated for
         */
        Pack getPack();
         ...
         *
         * @param time pseudo time of last access to this cache page
         */
