...
public abstract class PackObjectSizeIndexWriter {
     ...
     *
     * @param os      Output stream where to write the index
     * @param minSize objects strictly smaller than this size won't be added to the
     ...
     *
     * @param objs objects in the pack, in sha1 order. Their position in the list
     *             matches their position in the primary index.
     * @throws IOException problem writing to the stream
     */
