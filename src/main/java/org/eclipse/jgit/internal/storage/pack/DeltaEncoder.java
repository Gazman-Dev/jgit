...
public class DeltaEncoder {
     ...
     *
     * @param out        buffer to store the instructions written.
     * @param baseSize   size of the base object, in bytes.
     * @param resultSize size of the resulting object, after applying this instruction
     *                   stream to the base object, in bytes.
     * @throws IOException the output buffer cannot store the instruction stream's
     ...
     * @param resultSize size of the resulting object, after applying this instruction
     *                   stream to the base object, in bytes.
     * @param limit      maximum number of bytes to write to the out buffer declaring
     ...
     * @throws IOException the instruction buffer can't store the instructions.
     */
     ...
     *
     * @param text the binary to insert.
     * @return true if the insert fits within the limit; false if the insert
     * would cause the instruction stream to exceed the limit.
     * @throws IOException the instruction buffer can't store the instructions.
     */
     ...
     *
     * @param text the binary to insert.
     * @param off  offset within {@code text} to start copying from.
     * @param cnt  number of bytes to insert.
     * @return true if the insert fits within the limit; false if the insert
     * would cause the instruction stream to exceed the limit.
     * @throws IOException the instruction buffer can't store the instructions.
     */
     ...
     *
     * @param offset position in the base object to copy from. This is absolute,
