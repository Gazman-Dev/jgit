...
public abstract class Reftable {
     ...
     *
     * @param refs references to convert into a reftable; may be empty.
     ...
     *
     * @param deletes if {@code true} deleted references will be returned. If
     ...
     * @throws IOException if references cannot be read.
     */
     ...
     * @throws IOException if logs cannot be read.
     */
     ...
     *
     * @param refName exact name of the reference whose log to read.
     ...
     *
     * @param refName     exact name of the reference whose log to read.
     * @param updateIndex most recent index to return first in the log cursor. Log
     ...
     *
     * @param refName reference name to find.
     ...
     *
     * @param refName reference name or subtree to find.
     ...
     *
     * @param symref reference to resolve.
