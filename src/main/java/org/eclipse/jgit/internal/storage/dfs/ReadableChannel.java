...
public interface ReadableChannel extends ReadableByteChannel {
     ...
     * @throws IOException the channel's current position cannot be obtained.
     */
     ...
     *
     * @param newPosition position to move the channel to. The next read will start from
     *                    here. This should be a multiple of the {@link #blockSize()}.
     * @throws IOException the position cannot be updated. This may be because the
     ...
     * @throws IOException the size cannot be determined.
     */
     ...
     * size is set to 0.
     *
     * @param bufferSize requested size of the read ahead buffer, in bytes.
     * @throws IOException if the read ahead cannot be adjusted.
     */
