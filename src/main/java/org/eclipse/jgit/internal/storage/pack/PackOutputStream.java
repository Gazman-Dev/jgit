...
public final class PackOutputStream extends CancellableDigestOutputStream {
     ...
     *
     * @param writeMonitor monitor to update on object output progress.
     * @param out          target stream to receive all object contents.
     * @param pw           packer that is going to perform the output.
     */
     ...
     *
     * @param otp the object to write.
     * @throws IOException the object cannot be read from the object reader, or the
     ...
     *
     * @param otp       the object to pack. Header information is obtained.
     * @param rawLength number of bytes of the inflated content. For an object that is
     ...
     * @throws IOException the underlying stream refused to accept the header.
     */
