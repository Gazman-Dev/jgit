...
public abstract class DfsObjDatabase extends ObjectDatabase {
    ...
    public enum PackSource {
        ...
        public static class ComparatorBuilder {
             ...
             * to this method.
             *
             * @param sources sources in this equivalence class.
             * @return this.
             */
             ...
             * @throws IllegalArgumentException not all {@link PackSource} instances were explicitly assigned
     ...
     * @param options    how readers should access the object database.
     */
     ...
     * heuristics.
     *
     * @param packComparator comparator.
     */
     ...
     * @throws IOException the pack list cannot be initialized.
     */
     ...
     * @param avoidUnreachableObjects if true, ignore objects that are unreachable.
     ...
     * @throws IOException a new unique pack description cannot be generated.
     */
     ...
     * @throws IOException the packs cannot be committed. On failure a rollback must
     ...
     * @param desc     description of the new packs.
     * @param replaces if not null, list of packs to remove.
     * @throws IOException the packs cannot be committed.
     ...
     * @throws IOException the packs cannot be listed and the object database is not
     ...
     *
     * @param desc description of pack related to the data that will be written.
     *             This is an instance previously obtained from
