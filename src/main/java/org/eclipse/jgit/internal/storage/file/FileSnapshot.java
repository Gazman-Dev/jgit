...
public class FileSnapshot {
     ...
     *
     * @param path the path to later remember. The path's current status
     ...
     *
     * @param modified the last modification time of the file
     * @return the snapshot.
     ...
     * This method should be invoked before the file is accessed.
     *
     * @param file the path to remember meta data for. The path's current status
     *             information is saved.
     */
     ...
     * @param file      the path to remember meta data for. The path's current status
     *                  information is saved.
     * @param useConfig if {@code true} read filesystem time resolution from
     ...
     *
     * @param path the path the snapshot describes.
