...
public class PackBitmapIndexBuilder extends BasePackBitmapIndex {
     ...
     * file.
     *
     * @param objects objects sorted by name. The list must be initially sorted by
     ...
     *
     * @param objectId the object id key for the bitmap.
     * @param bitmap   the bitmap
     * @param flags    the flags to be stored with the bitmap
     */
     ...
     * file.
     *
     * @param c      the commit corresponds to the bitmap.
     * @param bitmap the bitmap to be written.
     * @param flags  the flags of the commit.
     */
     ...
     *
     * @param size the expected number of bitmap entries to be written.
     */
