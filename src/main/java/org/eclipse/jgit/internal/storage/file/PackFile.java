...
public class PackFile extends File {
     ...
     *
     * @param file File pointing to the location of the file.
     */
     ...
     * Create a PackFile for a pack or related file.
     *
     * @param directory Directory to create the PackFile in.
     * @param id        the {@link ObjectId} for this pack
     * @param ext       the <code>packExt</code> of the name.
     */
     ...
     *
     * @param directory Directory to create the PackFile in.
     * @param id        the <code>id</code> (40 Hex char) section of the pack name.
     * @param ext       the <code>packExt</code> of the name.
     */
     ...
     *
     * @param directory Directory to create the PackFile in.
     * @param name      Filename (last path section) of the PackFile
     */
     ...
     *
     * @param ext PackExt the extension to use.
     ...
     *
     * @param directory Directory to create the new PackFile in.
