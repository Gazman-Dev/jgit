...
public class ReftableConfig {
     ...
     *
     * @param szBytes desired output block size for references, in bytes.
     */
     ...
     *
     * @param szBytes desired output block size for log entries, in bytes. If 0 will
     ...
     *
     * @param interval number of references between binary search markers. If
     ...
     *
     * @param levels maximum number of levels to use in indexes. Lower levels of
     ...
     *
     * @param align if {@code true} blocks are written aligned to multiples of
     ...
     *
     * @param index if {@code true} the reftable may include additional storage to
