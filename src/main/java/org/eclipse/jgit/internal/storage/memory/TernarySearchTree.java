 ...
 *
 * @param <Value> type of values in this tree
 * @since 6.5
 */
public final class TernarySearchTree<Value> {
     ...
     * iterable
     *
     * @param loader iterable providing key-value pairs to load
     ...
     * Delete entries
     *
     * @param delete iterable providing keys of entries to be deleted
     * @return number of key-value pairs
     */
     ...
     *
     * @param map map of key-value pairs to insert
