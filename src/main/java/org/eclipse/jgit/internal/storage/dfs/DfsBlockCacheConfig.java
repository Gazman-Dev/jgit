...
public class DfsBlockCacheConfig {
     ...
     *
     * @param newLimit maximum number bytes of heap memory to dedicate to caching
     ...
     *
     * @param newSize size in bytes of a single window read in from the pack file.
     ...
     *
     * @param newConcurrencyLevel the estimated number of threads concurrently accessing the
     *                            cache.
     * @return {@code this}
     */
     ...
     *
     * @param ratio percentage of cache to occupy with a copied pack.
     * @return {@code this}
     */
     ...
     *
     * @param c consumer of wait time in milliseconds.
     * @return {@code this}
     */
     ...
     *
     * @param cacheHotMap map of hot count per pack extension for {@code DfsBlockCache}.
     * @return {@code this}
     */
     ...
     *
     * @param indexEventConsumer consumer of cache index events.
     * @return {@code this}
     */
    ...
    public interface IndexEventConsumer {
         ...
         * cache or storage.
         *
         * @param packExtPos           position in {@code PackExt} enum
         * @param cacheHit             true if an index was already in cache. Otherwise, the
         *                             index was loaded from storage into the cache in the
         *                             current request,
         * @param loadMicros           time to load an index from cache or storage in
         *                             microseconds
         * @param bytes                number of bytes loaded
         * @param lastEvictionDuration time since last eviction, 0 if was not evicted yet
         */
         ...
         * @param totalCacheHitCount   number of times an index was accessed while in cache
         * @param lastEvictionDuration time since last eviction, 0 if was not evicted yet
         */
