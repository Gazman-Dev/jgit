...
public class DfsReftable extends BlockBasedFile {
     ...
     *
     * @param desc description of the reftable within the DFS.
     */
     ...
     * Construct a reader for an existing reftable.
     *
     * @param cache cache that will store the reftable data.
     * @param desc  description of the reftable within the DFS.
     */
     ...
     *
     * @param ctx reader to access the DFS storage.
     * @return cursor to read the table; caller must close.
     * @throws IOException table cannot be opened.
     */
