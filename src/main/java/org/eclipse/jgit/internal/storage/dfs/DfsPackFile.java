...
public final class DfsPackFile extends BlockBasedFile {
     ...
     *
     * @param cache cache that owns the pack data.
     * @param desc  description of the pack within the DFS.
     */
     ...
     *
     * @param ctx reader context to support reading from the backing store if
     *            the index is not already loaded in memory.
     * @return the PackIndex.
     * @throws IOException the pack index is not available, or is corrupt.
     */
     ...
     * @throws IOException the bitmap index is not available, or is corrupt.
     */
     ...
     * @param ctx reader context to support reading from the backing store if
     *            the index is not already loaded in memory.
     * @return {@link CommitGraph},
     * null if pack doesn't have it.
     * @throws IOException the Commit Graph is not available, or is corrupt.
     */
     ...
     *
     * @param ctx temporary working space associated with the calling thread.
     * @param id  the object to obtain from the pack. Must not be null.
     * @return the object loader for the requested object if it is contained in
     * this pack; null if the object was not found.
     * @throws IOException the pack file or the index could not be read.
     */
     ...
     *
     * @param ctx current reader for the calling thread.
     * @return number of objects in index of this pack, likewise in this pack
     * @throws IOException the index file cannot be loaded into memory.
     */
     ...
     * @throws IOException a problem accessing storage while looking for the index
     */
     ...
     * @throws IOException no object size index or a problem loading it.
     */
     ...
     * @param ctx reader context to support reading from the backing store if
     *            the object size index is not already loaded in memory.
     * @param id  object id of an object in the pack
     * @return size of the object from the index. Negative if object is not in
     * the index (below threshold or not a blob)
     * @throws IOException could not read the object size index. IO problem or the pack
     *                     doesn't have it.
     */
