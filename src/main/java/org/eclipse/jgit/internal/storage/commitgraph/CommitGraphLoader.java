...
public class CommitGraphLoader {
     ...
     *
     * @param graphFile existing commit-graph to read.
     * @return a copy of the commit-graph file in memory
     * @throws FileNotFoundException      the file does not exist.
     * @throws CommitGraphFormatException commit-graph file's format is different from we expected.
     ...
     * @return a copy of the commit-graph file in memory
     * @throws CommitGraphFormatException the commit-graph file's format is different from we expected.
