...
public class DfsReader extends ObjectReader implements ObjectReuseAsIs {
     ...
     *
     * @param packBitmapIndex packBitmapIndex found in a pack (never null)
     ...
     *
     * @param file     the file the desired window is stored within.
     * @param position position within the file to read from.
     ...
     * available.
     * @throws IOException this cursor does not match the provider or id and the proper
     ...
     *
     * @param pack       the file the desired window is stored within.
     * @param position   position within the file to read from.
     * @param dstbuf     destination buffer the inflater should output decompressed
     *                   data to. Must be large enough to store the entire stream,
     *                   unless headerOnly is true.
     * @param headerOnly if true the caller wants only {@code dstbuf.length} bytes.
     * @return number of bytes inflated into <code>dstbuf</code>.
     * @throws IOException         this cursor does not match the provider or id and the proper
     *                             window could not be acquired through the provider's cache.
     * @throws DataFormatException the inflater encountered an invalid chunk of data. Data
    ...
    protected interface PackLoadListener {
         ...
         * @param loadedIdx reference to the loaded index
         */
         ...
         *
         * @param packName     Name of the pack this block belongs to
         * @param src          Source of the pack (e.g. GC, COMPACT, ...)
         * @param ext          Extension in the pack (e.g. PACK or REFTABLE)
         * @param position     Offset in the file requested by caller
         * @param dfsBlockData Metadata of the block
         */
