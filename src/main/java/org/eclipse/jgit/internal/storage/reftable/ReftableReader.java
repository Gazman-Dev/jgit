...
public class ReftableReader extends Reftable implements AutoCloseable {
     ...
     *
     * @param src the file content to read.
     */
     ...
     * @throws IOException size cannot be obtained.
     */
    ...
    private class LogCursorImpl extends LogCursor {
         ...
         *
         * @param scanEnd end of the log data in the reftable.
         * @param match   if non-null, limits the scan to precisely that refname.
         */
