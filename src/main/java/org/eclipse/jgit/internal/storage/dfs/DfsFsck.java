...
public class DfsFsck {
     ...
     * database.
     *
     * @param pm callback to provide progress feedback during the check.
     * @return all errors about the repository.
     * @throws IOException if encounters IO errors during the process.
     */
     ...
     * call.
     *
     * @param objChecker A customized object checker.
     */
     ...
     * check connectivity.
     *
     * @param connectivityOnly whether fsck should bypass object validity and integrity
