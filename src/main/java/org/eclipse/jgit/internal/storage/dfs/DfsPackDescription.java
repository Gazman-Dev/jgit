...
public class DfsPackDescription {
     ...
     * fewer objects before packs with more objects.
     *
     * @param packSourceComparator comparator for the {@link PackSource}, used as the first step in
     *                             comparison.
     * @return comparator.
     */
    public static Comparator<DfsPackDescription> objectLookupComparator(
     ...
     * @param packSource the source of the pack.
     */
     ...
     *
     * @param source the source of the pack.
     * @return {@code this}
     */
     ...
     *
     * @param timeMillis time the pack was created, in milliseconds. 0 if not known.
     * @return {@code this}
     */
     ...
     *
     * @param min minUpdateIndex for the reftable.
     * @return {@code this}
     */
     ...
     *
     * @param max maxUpdateIndex for the reftable.
     * @return {@code this}
     */
     ...
     *
     * @param ext   the file extension.
     * @param bytes size of the file in bytes. If 0 the file is not known and will
     ...
     *
     * @param ext       the file extension.
     * @param blockSize blockSize of the file, in bytes. If 0 the blockSize is not
     ...
     *
     * @param estimatedPackSize estimated size of the .pack file in bytes. If 0 the pack file
     *                          size is unknown.
     * @return {@code this}
     */
     ...
     *
     * @param cnt number of objects in the pack.
     * @return {@code this}
     */
     ...
     *
     * @param cnt number of delta compressed objects in the pack.
     * @return {@code this}
     */
     ...
     *
     * @param version the version of the index file written.
     * @return {@code this}
     */
