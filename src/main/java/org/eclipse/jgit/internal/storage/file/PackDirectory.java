...
class PackDirectory {
     ...
     *
     * @param config    configuration this directory consults for write settings.
     * @param directory the location of the {@code pack} directory.
     */
     ...
     *
     * @param objectId identity of the object to find the Pack for.
    ...
    /**
     * @param n count of consecutive failures
