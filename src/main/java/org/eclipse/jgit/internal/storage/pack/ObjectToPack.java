...
public class ObjectToPack extends PackedObjectInfo {
     ...
     *
     * @param src  object id of object for packing
     * @param type real type code of the object, not its in-pack type.
     */
     ...
     * in a created pack.
     *
     * @param deltaBase delta base object or null if object should be packed as a
     *                  whole object.
     */
     ...
     *
     * @param flag the flag mask to test, must be between 0x0 and 0xf.
     ...
     *
     * @param flag the bits to set, must be between 0x0 and 0xf.
     */
     ...
     *
     * @param flag the bits to clear, must be between 0x0 and 0xf.
     */
     ...
     *
     * @param extFlags additional flag bits to store in the flags field. Due to space
     ...
     *
     * @param ref the object representation.
     */
