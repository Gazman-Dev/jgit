...
public class ReftableCompactor {
     ...
     *
     * @param out stream to write the compacted tables to. Caller is responsible
     ...
     *
     * @param cfg configuration for the reftable.
     * @return {@code this}
     */
     ...
     * partial compaction.
     *
     * @param deletes {@code true} to include deletions in the output, which may be
     ...
     * reftable.
     *
     * @param min the minimum update index for log entries that appear in the
     ...
     * reftable.
     *
     * @param max the maximum update index for log entries that appear in the
     ...
     *
     * @param timeMillis oldest log time to preserve. Entries whose timestamps are
     ...
     *
     * @param readers tables to compact. Tables should be ordered oldest first/most
     *                recent last so that the more recent tables can shadow the
     *                older results. Caller is responsible for closing the readers.
     * @throws IOException update indexes of a reader cannot be accessed.
     */
     ...
     *
     * @throws IOException if tables cannot be read, or cannot be written.
     */
