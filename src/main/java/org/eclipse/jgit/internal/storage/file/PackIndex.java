...
public abstract class PackIndex
     ...
     * </p>
     *
     * @param idxFile existing pack .idx to read.
     * @return access implementation for the requested file.
     * @throws FileNotFoundException the file does not exist.
     * @throws IOException           the file exists but could not be read due to security errors,
     ...
     * caller. The file may or may not be held open by the returned instance.
     *
     * @param fd stream to read the index file from. The stream must be
     *           buffered as some small IOs are performed against the stream.
     *           The caller is responsible for closing the stream.
     * @return a copy of the index in-memory.
     * @throws IOException            the stream cannot be read.
     * @throws CorruptObjectException the stream does not contain a valid pack index.
     */
     ...
     *
     * @param id the object to look for. Must not be null.
     ...
     * </pre>
     *
     * @param nthPosition position within the traversal of {@link #iterator()} that the
     ...
     * </pre>
     *
     * @param nthPosition unsigned 32 bit position within the traversal of
     ...
     *
     * @param objId name of the object to locate within the pack.
     ...
     *
     * @param objId name of the object to locate within the index
     ...
     * (including header).
     *
     * @param objId id of object to look for
     * @return CRC32 checksum of specified object (at 32 less significant bits)
     * @throws MissingObjectException        when requested ObjectId was not found in this index
     * @throws UnsupportedOperationException when this index doesn't support CRC32 checksum
     */
     ...
     *
     * @param matches    set to add any located ObjectIds to. This is an output
     *                   parameter.
     * @param id         prefix to search for.
     * @param matchLimit maximum number of results to return. At most this many
     *                   ObjectIds should be added to matches before returning.
     * @throws IOException the index cannot be read.
     */
