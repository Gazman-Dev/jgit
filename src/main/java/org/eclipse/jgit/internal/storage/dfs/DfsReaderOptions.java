...
public class DfsReaderOptions {
     ...
     * during copying.
     *
     * @param bufsz new buffer size in bytes for buffers used when streaming pack
     ...
     *
     * @param loadRevIndexInParallel whether to load reverse index in parallel.
     * @return {@code this}
     */
