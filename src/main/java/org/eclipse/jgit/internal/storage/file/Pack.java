...
public class Pack implements Iterable<PackIndex.MutableEntry> {
     ...
     * @param packFile      path of the <code>.pack</code> file holding the data.
     * @param bitmapIdxFile existing bitmap index file with the same base as the pack
     */
     ...
     *
     * @param curs temporary working space associated with the calling thread.
