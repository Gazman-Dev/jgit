...
public final class NetscapeCookieFile {
    ...
    /**
     * @param path where to find the cookie file
     */
     ...
     *
     * @param refresh if {@code true} updates the list from the underlying cookie
     ...
     * @param createdAt cookie creation time; used to calculate the maxAge based on
     ...
     * @throws IOException              if the given file could not be read for some reason
     * @throws IllegalArgumentException if the given file does not have a proper format
     */
     ...
     *
     * @param url url for which to write the cookies (important to derive
     *            default values for non-explicitly set attributes)
     * @throws IOException          if the underlying cookie file could not be read or written or
     ...
     * (also used by curl).
     *
     * @param writer    the writer to use to persist the cookies
     * @param cookies   the cookies to write into the file
     * @param url       the url for which to write the cookie (to derive the default
     *                  values for certain cookie attributes)
     * @param createdAt cookie creation time; used to calculate a cookie's expiration
     *                  time
     ...
     *
     * @param cookies1 first set of cookies
     * @param cookies2 second set of cookies
