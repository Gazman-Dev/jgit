...
public class FilteredRenameDetector {
    ...
    /**
     * @param repository The repository in which to check for renames.
     */
    ...
    /**
     * @param renameDetector The {@link RenameDetector} to use when checking for renames.
     */
     ...
     *
     * @param diffs      The set of changes to check.
     * @param pathFilter Filter out changes that didn't affect this path.
     ...
     *
     * @param changes     The set of changes to check.
     * @param pathFilters Filter out changes that didn't affect these paths.
