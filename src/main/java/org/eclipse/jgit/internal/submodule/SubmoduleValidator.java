...
public class SubmoduleValidator {
    ...
    public static class SubmoduleValidationException extends Exception {
         ...
         * @param fsckMessageId Error identifier, following the git fsck
         *                      fsck.&lt;msg-id&gt; format
         */
     ...
     *
     * @param name name of a submodule
     * @throws SubmoduleValidationException name doesn't seem valid (detail in message)
     */
     ...
     *
     * @param uri uri of a submodule
     * @throws SubmoduleValidationException uri doesn't seem valid
     */
     ...
     *
     * @param path path of a submodule
     * @throws SubmoduleValidationException path doesn't look right
     */
     ...
     *
     * @param gitModulesContents Contents of a .gitmodule file. They will be parsed internally.
     * @throws SubmoduleValidationException if the contents don't look like a configuration file or field
